...
import com.hand.hcf.app.base.dataAuthority.domain.DataAuthorityRule;
...
import com.hand.hcf.app.base.dataAuthority.persistence.DataAuthorityRuleMapper;
...
public class DataAuthorityRuleService extends BaseService<DataAuthorityRuleMapper, DataAuthorityRule> {
    ...
    public List<DataAuthRuleDetailValueDTO> getDataAuthRuleDetailValuesByDataType(Long ruleId,
        ...
        Map<String, SysCodeValue> filtrateMethodMap = sysCodeService.listAllSysCodeValueBySysCode("3103").stream().collect(Collectors.toMap(e -> e.getValue(), e -> e));
        switch (dataAuthorityRuleDetail.getDataScope()) {
            ...
            case "1001": {
               ...
               /* if (DataAuthorityUtil.COMPANY_COLUMN.equals(dataType)) {
                    ...
                    List<UserDTO> usersByTenantId = userService.listDtoByQO(page,
                            UserQO.builder().tenantId(LoginInformationUtil.getCurrentTenantId())
                                    .hasDepartment(false)
                                    .keyContact(keyWord)
                                    .hasCompany(false).build());
                    return userToDetailValueDTO(usersByTenantId, getFiltrateMethodDescription(filtrateMethodMap, dataAuthorityRuleDetail.getFiltrateMethod()));
                }*/
                break;
            }
            // 当前
            case "1002": {
                page.setTotal(1);
                /*if (DataAuthorityUtil.SOB_COLUMN.equals(dataType)) {
                    SetOfBooks setOfBookById = sobService.selectById(LoginInformationUtil.getCurrentSetOfBookId());
                    ...
                    CompanyDTO companyById = companyService.findCompanyById(LoginInformationUtil.getCurrentCompanyId());
                    ...
                    return departmentToDetailValueDTO(Arrays.asList(departmentService.selectOnebyId(unitIdByUserId)), getFiltrateMethodDescription(filtrateMethodMap, dataAuthorityRuleDetail.getFiltrateMethod()));
                } else if (DataAuthorityUtil.EMPLOYEE_COLUMN.equals(dataType)) {
                    UserDTO userInfoDTO = userService.getDtoByQO(
                            UserQO.builder().id(
            ...
            case "1003": {
                /*if (DataAuthorityUtil.COMPANY_COLUMN.equals(dataType)) {
                    Page<CompanyCO> sonAndOwnCompanyByCond = companyService.pageChildrenCompaniesByCondition(LoginInformationUtil.getCurrentCompanyId(),
                    ...
                    Long unitIdByUserId = departmentGroupService.selectByEmpOid(LoginInformationUtil.getCurrentUserOid().toString()).getDepartmentId();
                    Page<Department> unitChildrenAndOwnByUnitId = departmentService.pageDepartmentChildrenById(unitIdByUserId,keyWord,true, page);
            ...
            case "1004": {
               ...
               /* if (DataAuthorityUtil.SOB_COLUMN.equals(dataType)) {
                    ...
                    List<UserDTO> userInfoDTOS = userService.listDtoByQO(
                            UserQO.builder().userIds(keyIds)
                                    .hasCompany(false)
    ...
    private String getFiltrateMethodDescription(Map<String, SysCodeValue> filtrateMethodMap, String filtrateMethod) {
        ...
        SysCodeValue sysCodeValue = filtrateMethodMap.get(filtrateMethod);
        if(sysCodeValue != null){
            return sysCodeValue.getName();
        }
        return "";
    }
  ...
  /*  private List<DataAuthRuleDetailValueDTO> setOfBooksToDetailValueDTO(List<SetOfBooks> setOfBooksInfoDTOS, String filtrateMethodDesc) {
   ...
   /* private List<DataAuthRuleDetailValueDTO> companyToDetailValueDTO(List<CompanyDTO> companySumDTOS, String filtrateMethodDesc) {
   ...
   /* private List<DataAuthRuleDetailValueDTO> userToDetailValueDTO(List<UserDTO> userInfoDTOS, String filtrateMethodDesc) {
           ...
           /* if (DataAuthorityUtil.SOB_COLUMN.equals(dataType)) {
                ...
                List<UserDTO> usersByTenantId = userService.listDtoByQO(page,
                        UserQO.builder().tenantId(LoginInformationUtil.getCurrentTenantId())
                                ...
                                .hasCompany(false)
                                .hasDepartment(false).build());
                return userToDetailValueDTO(usersByTenantId, null);
            }*/
            // 已选择

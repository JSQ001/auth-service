...
import com.hand.hcf.app.base.constant.ElasticSearchConstants;
import com.hand.hcf.app.base.domain.UserDevice;
import com.hand.hcf.app.base.domain.UserLoginLog;
...
public class ArtemisTokenStore extends JdbcTokenStore {
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        if (StringUtils.hasText(login)) {
            ...
            try {
                IndexResponse response = client.prepareIndex(ElasticSearchConstants.USER_LOGIN_LOG_INDEX, ElasticSearchConstants.DEFAULT_INDEX_TYPE)

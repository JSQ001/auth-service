package com.hand.hcf.app.mdata.aop;

import com.hand.hcf.app.mdata.config.RequestContext;
import com.hand.hcf.app.mdata.utils.HttpRequestUtil;
...
@Aspect
@Order(1)
public class ResourceMdataAspect {
    public static Logger log = LoggerFactory.getLogger(ResourceMdataAspect.class);
    @Around("within(com.hand.hcf.*)")

...
public class ResponsibilityCenterGroupService extends BaseService<ResponsibilityCenterGroupMapper, ResponsibilityCenterGroup> {
     ...
     * @return
     */
    public Page<ResponsibilityCenterGroup> pageResponsibilityCenterGroupBySetOfBooksId(Long setOfBooksId, String groupCode, String groupName, Boolean enabled, Page page) {

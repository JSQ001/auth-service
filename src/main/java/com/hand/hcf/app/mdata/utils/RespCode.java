...
public interface RespCode {
    ...
    String LEGAL_ENTITY_ACCOUNT_BANK_NULL = "LEGAL_ENTITY_ACCOUNT_BANK_NULL"; //法人开户行不能为空
    String LEGAL_ENTITY_ADDRESS_NULL = "LEGAL_ENTITY_ADDRESS_NULL"; //法人地址不能为空
    String LEGAL_ENTITY_PHONE_NULL = "LEGAL_ENTITY_PHONE_NULL"; //法人电话不能为空
    String LEGAL_ENTITY_ACCOUNT_NUMBER_NULL = "LEGAL_ENTITY_ACCOUNT_NUMBER_NULL"; //银行卡号不能为空
    String LEGAL_ENTITY_SET_BOOK_NULL = "LEGAL_ENTITY_SET_BOOK_NULL"; //帐套不能为空
    String LEGAL_ENTITY_TAX_NUMBER_EXISTS = "LEGAL_ENTITY_TAX_NUMBER_EXISTS"; //纳税人识别号已存在
    String PARENT_LEGAL_ENTITY_NOT_EXISTS_IN_CURRENT_BOOK = "PARENT_LEGAL_ENTITY_NOT_EXISTS_IN_CURRENT_BOOK"; //上级法人在当前帐套下不存在
    String LEGAL_ENTITY_SET_BOOK_MUST_BE_TENANT_BOOK = "LEGAL_ENTITY_SET_BOOK_MUST_BE_TENANT_BOOK";//帐套必须为租户下帐套
    ...
    String ACCOUNTS_ENABLED_NULL = "ACCOUNTS_ENABLED_NULL" ;     //是否启用不能为空
    String ACCOUNTS_SUMMARY_FLAG_NULL = "ACCOUNTS_SUMMARY_FLAG_NULL" ;     //汇总标志不能为空
    String ACCOUNTS_TYPE_NULL = "ACCOUNTS_ACCOUNT_TYPE_NULL" ;     //科目类型不能为空
    String ACCOUNTS_BALANCE_DIRECTION_NULL = "ACCOUNTS_BALANCE_DIRECTION_NULL" ;     //余额方向不能为空
    String ACCOUNTS_PARENT_ACCOUNT_CODE_NULL = "ACCOUNTS_PARENT_ACCOUNT_CODE_NULL"; //父科目代码不能为空
    String ACCOUNTS_PARENT_ACCOUNT_CODE_NOT_EXISTS = "ACCOUNTS_PARENT_ACCOUNT_CODE_NOT_EXISTS"; //父科目代码不存在
    String ACCOUNTS_SUB_ACCOUNT_CODE_NULL = "ACCOUNTS_SUB_ACCOUNT_CODE_NULL"; //子科目代码不能为空
    String ACCOUNTS_SUB_ACCOUNT_CODE_NOT_EXISTS = "ACCOUNTS_SUB_ACCOUNT_CODE_NOT_EXISTS"; //子科目代码不存在

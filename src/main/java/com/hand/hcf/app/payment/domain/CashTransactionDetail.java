...
public class CashTransactionDetail extends Domain {
     ...
     * 单据明细付款行id
     */
	@ApiModelProperty(value = "单据明细付款行id")
	@NotNull
	...
	//收款方类型名称
	@ApiModelProperty(value = "收款方类型名称")
	@TableField(exist = false)
	...
	//出纳人name
	@ApiModelProperty(value = "出纳人name")
	@TableField(exist = false)
     ...
     * 付款方银行户名
     */
	@ApiModelProperty(value = "付款方银行户名")
	@NotNull
     ...
     * 收款方开户行行号
     */
	@ApiModelProperty(value = "收款方开户行行号")
	@NotNull
     ...
     * 实际结果码
     */
	@ApiModelProperty(value = "实际结果码")
	@TableField("result_code")
	private String resultCode;
    /**
     * 实际结果信息
     */
	@ApiModelProperty(value = "实际结果信息")
	...
	@ApiModelProperty(value = "原支付明细ID")
	...
	@ApiModelProperty(value = "已提交退款金额")
	@TableField(exist = false)
     ...
     * 业务单据备注字段
     */
	@ApiModelProperty(value = "业务单据备注字段")

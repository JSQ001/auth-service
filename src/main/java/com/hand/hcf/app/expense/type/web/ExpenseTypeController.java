...
import com.hand.hcf.app.expense.type.service.ExpenseTypeExpandFieldService;
...
public class ExpenseTypeController {
    ...
    @Autowired
    private ExpenseTypeExpandFieldService expenseTypeExpandFieldService;
     ...
     * @return
     */
    @PostMapping("/{expenseTypeId}/expand/field")
    public ResponseEntity<List<ExpenseTypeExpandField>> saveExpandInfo(@RequestBody List<ExpenseTypeExpandField> expandFields,
                                                               @PathVariable("expenseTypeId") Long expenseTypeId) {
        for(int i= 0;i<expandFields.size();i++){
            expenseTypeExpandFieldService.saveExpandField(expandFields.get(i),expenseTypeId);
        }
       return ResponseEntity.ok(expandFields);
    }
     ...
     * @return
     */
    @GetMapping("/{expenseTypeId}/expand/query")
    public ResponseEntity queryExpandField(@PathVariable("expenseTypeId") Long expenseTypeId) {

        return ResponseEntity.ok(expenseTypeExpandFieldService.queryExpandField(expenseTypeId));

...
public class PaymentService {
    ...
    public List<CashTransactionClassCO> listCashTransactionClassByRange(
        ...
        //jiu.zhao 修改三方接口
        Page<CashTransactionClassCO> cashTransactionClassCOPage = paymentClient.listCashTransactionClassByRange(forArtemisCO, page.getCurrent() - 1, page.getSize());
     ...
     * @return
     */
    public String updateAuditChangeWriteOffStatus(String documentType,
                                                  Long documentHeaderId,
                                                  Long operatorId,
                                                  Integer operationType) {
        return paymentClient.updateAuditChangeWriteOffStatus(documentType, documentHeaderId, operatorId, operationType);
    }
}
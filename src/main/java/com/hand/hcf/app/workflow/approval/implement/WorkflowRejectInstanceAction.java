...
public class WorkflowRejectInstanceAction implements WorkflowAction {
    ...
    /** 动作名称 */
    public static final String ACTION_NAME = "rejectInstance";
    /** 驳回成功 */
    public static final String RESULT_REJECT_SUCCESS = "rejectSuccess";

    public WorkflowRejectInstanceAction(WorkflowRejectService service, WorkflowInstance instance, WorkflowUser user, String remark) {
    ...
    public WorkflowResult execute() {
        // 驳回实例
        return service.rejectInstance(instance, user, remark);
    }

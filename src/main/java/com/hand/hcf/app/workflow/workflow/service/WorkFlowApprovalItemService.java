...
import static com.hand.hcf.app.workflow.constant.RuleConstants.*;
 ...
 */
@Service
public class WorkFlowApprovalItemService {
    public static Logger logger = LoggerFactory.getLogger(WorkFlowApprovalItemService.class);
    ...
    protected BuildApprovalChainResult buildNextApprovalChainByRule(Integer approvalPathType, UUID ruleApprovalNodeOid, boolean isFirstNode,WorkFlowDocumentRef workFlowDocumentRef) {
        ...
        if (CollectionUtils.isNotEmpty(robotList)) {
            ...
            if (ruleApprovalNodeDTO.getApprovalActions().contains(String.valueOf(ACTION_APPROVAL_PASS))) {
                ...
                workflowApprovalService.passWorkflow(UUID.fromString(APPROVER_TYPE_ROBOT_OID), approvalReqDTO,formOid);
                ...
                workflowApprovalService.rejectWorkflow(UUID.fromString(APPROVER_TYPE_ROBOT_OID), approvalReqDTO);

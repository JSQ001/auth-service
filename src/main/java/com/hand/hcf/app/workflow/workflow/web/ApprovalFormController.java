...
public class ApprovalFormController {
    ...
    public ResponseEntity<ApprovalFormDTO> getCustomForm(@PathVariable UUID formOid) {
        ApprovalFormDTO customForm = approvalFormService.getDTOByOidAndUserOid(formOid, OrgInformationUtil.getCurrentUserOid());
    ...
    public ResponseEntity<List<ApprovalForm>> getCompanyCustomForms(@RequestParam(value = "roleType", required = false) String roleType,
        ...
        if (roleType != null && Constants.ROLE_TENANT.equals(roleType) && StringUtils.isNotEmpty(booksId)) {
            lists = approvalFormService.listDTOByTenantAndCondition(OrgInformationUtil.getCurrentTenantId(), Long.parseLong(booksId), formTypeId,formName,remark,valid,page);
        ...
        if (String.valueOf(ApprovalFormEnum.CUSTOMER_FROM_TENANT.getId()).equals(fromType)) {
            lists = approvalFormService.listBySetOfBooksAndCondition(OrgInformationUtil.getCurrentSetOfBookId(),null,null,null,page);
   ...
   /* @RequestMapping(value = "/custom/forms/company/my/available/get/all", method = RequestMethod.GET)
    ...
    public ResponseEntity<List<ApprovalFormSummaryDTO>> getAvailableSetOfBootsCustomForm(@RequestParam(name = "formTypeId", required = true) Integer formTypeId,
        ...
        List<ApprovalFormSummaryDTO> approvalFormSummaryDTOS = approvalFormService.selectFormBySetOfBooksIdAndFormType(setOfBooksId, formTypeId);
    ...
    @RequestMapping(value = "/custom/forms/user/scope", method = RequestMethod.POST)
    public ResponseEntity<ResponseDataDTO> associateUserScope(@RequestBody ApprovalFormUserScopeDTO dto) {
        approvalFormService.associateCustomFormUserScope(dto);
        return ResponseEntity.ok(ResponseDataDTO.ok());
    }
     ...
     * @return
     */
    @RequestMapping(value = "/custom/forms/{formOid}/user/scope", method = RequestMethod.GET)
    public ResponseEntity<ApprovalFormUserScopeDTO> getSelectedUserGroups(@PathVariable UUID formOid) {
        return ResponseEntity.ok(approvalFormService.getAssociatedUserScope(formOid, OrgInformationUtil.getCurrentUserOid()));
    }
...
/*
  ...
  /*  @RequestMapping(value = "/custom/forms/disable/{formOid}", method = RequestMethod.POST)
    ...
    public ResponseEntity<List<ApprovalFormSummaryDTO>> getCompanyCustomForms(@RequestParam(value = "enabledFlag", required = false) Integer enabledFlag, @RequestParam(value = "formTypes") List<Integer> formTypes) throws URISyntaxException {
        List<ApprovalFormSummaryDTO> customFormDTOs = approvalFormService.listSummaryFormByUserOid(OrgInformationUtil.getCurrentUserOid());

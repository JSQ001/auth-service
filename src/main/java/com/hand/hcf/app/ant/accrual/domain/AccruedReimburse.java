...
public class AccruedReimburse extends Domain {
    /**
     * 单据编号
     */
    ...
    * */
    @TableField(exist = false)
    private  BigDecimal accrualAmountFrom;

    /*
     * 金额至
     * */
    @TableField(exist = false)
    private  BigDecimal accrualAmountTo;
    ...
    * */
    ...
    @TableField(exist = false)
    private  String accrualDateFrom;

    @TableField(exist = false)
    private  String accrualDateTo;

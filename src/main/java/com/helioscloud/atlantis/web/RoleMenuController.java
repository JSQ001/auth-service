...
public class RoleMenuController {
     ...
     * @apiParamExample {json} 请求报文
     * http://localhost:9082/api/roleMenu/query/role?roleId=1029919265725378561&isDeleted=true&page=0&size=2
     * @apiSuccessExample {json} 返回报文:
     * [
     * {
     * "id": 1029987832156180482,
    ...
    public ResponseEntity<List<RoleMenuDTO>> getRoleMenusByRoleId(@RequestParam(required = true) Long roleId,
        ...
        List<RoleMenuDTO> list = roleMenuService.getRoleMenusByRoleId(roleId, isDeleted, isEnabled, page);

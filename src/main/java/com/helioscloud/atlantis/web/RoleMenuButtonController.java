...
public class RoleMenuButtonController {
     ...
     * @apiParamExample {json} 请求报文
     * http://localhost:9082/api/roleMenuButton/query/role?roleId=1029919265725378561&isDeleted=true&page=0&size=2
     * @apiSuccessExample {json} 返回报文:
     * [
     * {
     * "id": "1030015747216375809",
    ...
    public ResponseEntity<List<RoleMenuButton>> getRoleMenuButtonByRoleId(@RequestParam(required = true) Long roleId,
        ...
        List<RoleMenuButton> list = roleMenuButtonService.getRoleMenuButtonByRoleId(roleId, isDeleted, isEnabled, page);

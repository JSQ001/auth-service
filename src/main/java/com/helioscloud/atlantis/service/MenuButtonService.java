...
public class MenuButtonService extends BaseService<MenuButtonMapper,MenuButton> {
    ...
    public MenuButton updateMenuButton(MenuButton menuButton){
        ...
        //校验ID是否在数据库中存在
        MenuButton rr = menuButtonMapper.selectById(menuButton.getId());
        if(rr == null){
     ...
     * @return
     */
    public List<MenuButton> getMenuButtons(Long menuId,Boolean isDeleted,Boolean isEnabled,Page page){

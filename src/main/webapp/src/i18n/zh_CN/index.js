...
import user from './system/user.json';
import app from './system/app.json';
import lov from './system/lov.json';
...
import BudgetJournal from './financial-view/budget-journal.json';
...
import workbenchBusinessType from './workbench/business-type/business-type';
//费用政策
import expensePolicy from './expense-policy/expense-policy.json';
...
const i18nList = [
  ...
  workbenchBusinessType, // 工作台业务类型定义
  expensePolicy, //费用政策
  BudgetJournal, //预算日记账财务查询
];

...
class PayMyBacklash extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      searchForm: [
        {
          ...
          colSpan: 6,
          id: 'billcode',
          label: this.$t({ id: 'pay.backlash.billCode' }),
        },
        {
          type: 'input',
          colSpan: 6,
          id: 'documentNumber',
          label: this.$t({ id: 'pay.backlash.documentNumber' }),
        },
        {
          type: 'value_list',
          colSpan: 6,
          id: 'documentTypeId',
          label: this.$t({ id: 'pay.backlash.documentTypeId' }),
          valueListCode: 2106,
          options: [],
          event: 'code',
        },
...

        {
          ...
          options: [],
          id: 'applicant',
          label: this.$t({ id: 'pay.backlash.employeeName' } /*申请人*/),
          labelKey: 'userName',
          valueKey: 'userId',
          single: true,
        }, //申请人
      ...
      columns: [
        {
          title: this.$t({ id: 'pay.backlash.billCode' }),
          dataIndex: 'billcode',
          width: 150,
          align: 'center',
          render: desc => (
        ...
        {
          title: this.$t({ id: 'pay.backlash.documentNumber' }),
        ...
        {
          title: this.$t({ id: 'pay.backlash.documentTypeId' }),
        ...
        {
          title: this.$t({ id: 'pay.backlash.employeeName' } /*申请人*/),
        ...
        {
          title: this.$t({ id: 'pay.backlash.amount' }),
          dataIndex: 'amount',
          render: desc => (
            <span>
        ...
        {
          title: this.$t({ id: 'pay.backlash.sign' }),
        ...
        {
          title: this.$t({ id: 'pay.backlash.payDate' }),
          dataIndex: 'payDate',
          render: desc => (
            <span>

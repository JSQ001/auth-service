...
class PaymentDetail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      financeColumns: [
        ...
        {
          title: messages('messages("chooser.data.dimension")'),
  ...
  handleBack = () => {
    this.context.router.replace(
      `${this.state.payWorkbench.url}?tab=${this.props.params.tab}&subTab=${
      ...
      <div className="payment-detail">
        <Spin spinning={loading}>
          ...
          <h3 className="header-title">
            {this.$t({ id: 'pay.workbench.detail.bills' }) /*付款单据*/}
          </h3>
          <Table
            rowKey="documentCode"
          ...
          />
          <h3 className="header-title">
            {this.$t({ id: 'pay.workbench.detail.detail' }) /*付款详情*/}
          </h3>
          <Table
            rowKey="draweeId"
          ...
          {detailData[0] && (
            <div>
              <Card bordered={false}>
                ...
                <Card.Grid style={gridRightStyle}>
                  {detailData[0].currency} {detailData[0].exchangeRate}
                </Card.Grid>
          ...
          <h3 className="header-title">
            {this.$t({ id: 'pay.workbench.detail.finance' }) /*财务信息*/}
          </h3>
          <Table
          ...
          <h3 className="header-title">
            {this.$t({ id: 'pay.workbench.detail.log' }) /*操作日志*/}
          </h3>
          <Table
            rowKey={(record, index) => index}
            columns={logColumns}

      ...
      if (!err) {
        ...
        payRefundService
          ...
          .catch(e => {
            ...
            message.error(
              this.$t({ id: 'common.operate.filed' } /*操作失败*/) + '!' + err.response.data.message
            );
          });
      }
    });
  ...
  render() {
    ...
    let uncheckButton = (
      <div className="slide-footer">
        <Button type="primary" onClick={this.saveFunction} loading={btnLoading}>
          {this.$t({ id: 'pay.refund.approved' } /*复核通过*/)}
        </Button>
        <Button onClick={this.onReject} style={{ color: '#fff', background: '#f04134' }}>
          {this.$t({ id: 'pay.refund.reject' } /*驳回*/)}
        </Button>
    ...
    return (
      <div className="new-payment-requisition-line">
        ...
        <Modal
          title={this.$t({ id: 'pay.refund.enterRejectInformation' } /*请输入驳回原因*/)}
        ...
        >
          <Form>
            <FormItem
              {...formItemLayout}
              label={this.$t({ id: 'pay.refund.information' } /*原因*/)}
            >
                ...
                rules: [
                  {
                    required: true,
                    message: this.$t(
                      { id: 'pay.refund.enterRejectInformation' } /*请输入驳回原因*/
                    ),
                  },
                ],
              })(
        ...
        <Modal
          title={this.$t({ id: 'pay.refund.approveInformation' } /*可输入审批意见*/)}

...
import WrappedTaxClientOtherDefine from './tax-client-application-other';
  ...
  render() {
    ...
    return (
      <div className="tax-client-detail">
            ...
            <Col span={5} offset={1}>
              <FormItem label="申请编号">
                {getFieldDecorator('applicationCode', {
                  initialValue: clientData.applicationCode || '',
                })(<Input disabled={true} />)}
              </FormItem>
            </Col>
            <Col span={5} offset={1}>
              <FormItem label="事务类型">
                {getFieldDecorator('transactionType', {
                  initialValue: clientData.transactionType || '',
                })(
            ...
            <Col span={5} offset={1}>
              <FormItem label="事务状态">
                {getFieldDecorator('transactionStatus', {
                  initialValue: clientData.transactionStatus || '',
                })(
                  <Select disabled placeholder={this.$t('common.please.select')}>
            ...
            <Col span={5} offset={1}>
              <FormItem label="申请人">
                {getFieldDecorator('employeeName', {
                  initialValue: clientData.employeeName || '',
                })(<Input disabled={true} />)}
              </FormItem>
            </Col>
          </Row>
        ...
        >
          <ApproveHistory type="904001" oid={clientData.documentOid} />
        </div>

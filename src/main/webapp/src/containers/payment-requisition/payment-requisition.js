...
class PaymentRequisition extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      newPaymentRequisition: '/my-payment-requisition/new-payment-requisition/:id/:typeId', //新建付款申请单
    };
  }
          ...
          <Row>
            <Col id="payment-requisition-drop" style={{ position: 'relative' }} span={18}>
              <div className="table-header-buttons">
                <Dropdown
                  getPopupContainer={() => document.getElementById('payment-requisition-drop')}
                  trigger={['click']}
                  overlay={

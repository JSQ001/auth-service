...
class EmployDistribution extends React.Component {
  ...
  render() {
    const { loading, employTypeList, employTypeInfo, pagination, columns, data } = this.state;
    const periodRow = [];
    const periodCol = [];
...
const wrappedCompanyDistribution = Form.create()(EmployDistribution);

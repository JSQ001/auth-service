...
export default {
  ...
  approveReject(id, remark, userId) {
    ...
    }/api/cash/prepayment/requisitionHead/updateStatus?id=${id}&status=1005&&userId=${userId}`;
  ...
  approvePass(id, remark, userId) {
    let url = `${
      config.prePaymentUrl
    }/api/cash/prepayment/requisitionHead/updateStatus?id=${id}&status=1004&userId=${userId}`;

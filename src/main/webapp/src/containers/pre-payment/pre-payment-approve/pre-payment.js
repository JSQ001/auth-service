    ...
    this.state = {
      ...
      columns: [
        ...
        // {title: '币种', dataIndex: 'currency'},
        {
          ...
          render: value => {
            return (
              <Popover content={this.filterMoney(value, 2)}>
                <div style={{ textAlign: 'right' }}>{this.filterMoney(value, 2)}</div>
              </Popover>
            );
          },
        },
            ...
            {tabValue === 'unapproved' && (
              <div>
                ...
                <CustomTable
                  ...
                  }/api/cash/prepayment/requisitionHead/approvals/filters`}

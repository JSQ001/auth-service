...
export default {
  ...
  cshWriteOffDoReserved(id, reverseAmount, remark, attachmentOid) {
    return httpFetch.post(
      `${
        config.payUrl
      }/api/payment/cash/write/off/do/reserved?id=${id}&reverseAmount=${reverseAmount}&remark=${remark}&attachmentOid=${attachmentOid}`
    );
  },
  /**
   * 获取我发起的核销反冲记录
  ...
  getWriteOffUserReservedDetail(params) {
    return httpFetch.get(
      `${config.payUrl}/api/payment/cash/write/off/user/reserved/detail`,
      params
    );
  },
  /**
  ...
  cshWriteOffDoReservedAgain(id, reverseAmount, remark, attachmentOid) {
    return httpFetch.post(
      `${
        config.payUrl
      }/api/payment/cash/write/off/do/reserved/again?id=${id}&reverseAmount=${reverseAmount}&remark=${remark}&attachmentOid=${attachmentOid}`
    );
  },
};

...
class FinanceAudit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      invoiceColumns: [
        ...
        {
          title: this.$t('finance.view.search.documentType' /*单据名称*/),
          dataIndex: 'formName',
          width: '10%',
        ...
        {
          title: this.$t('finance.audit.reimbursement' /*报销单号*/),
        ...
        },
        {
          title: (
            <Popover
              content={this.$t('finance.audit.payCurrency' /*支付币种*/)}
        ...
        {
          title: this.$t('finance.audit.duePay' /*待支付金额*/),
      ...
      borrowColumns: [
        ...
        },
        {
          ...
          dataIndex: 'currencyCode',
          width: '10%',
          render: text => text || this.props.company.baseCurrency,
        },
        {
          title: this.$t('finance.audit.duePay' /*待支付金额*/),
      ...
      searchForm: [
        ...
        },
        {
          ...
          placeholder:
            ...
            this.$t('finance.view.search.application' /*请输入姓名／工号*/),
          options: [],
        ...
        },
        {
          ...
          options: [],
          getUrl: `${config.mdataUrl}/api/v2/my/company/receipted/invoices?page=0&size=100`,
          method: 'get',
  ...
  getForms = () => {
    ...
    Promise.all([
      ...
      checkboxListForm.items = [
        {
          label: this.$t('finance.audit.formType' /*表单类型*/),
          key: 'form',
  ...
  renderAllExpandedRow = record => {
    ...
    if (record.warningList) {
      ...
      content &&
        result.push(
          this.renderExpandedRow(this.$t('common.label'), content.substr(0, content.length - 1))
        );
    }
    if (record.printFree) {
      result.push(
    ...
    if (record.noticeFlag) {
      result.push(
        this.renderExpandedRow(
          this.$t('finance.view.column.notice'),
          this.$t('finance.view.column.noticeContent')
        )
      );
    }
    if (result.length > 0) {

  ...
  constructor(props) {
    ...
    this.state = {
      columns: [
        ...
        {
          //反冲本币金额
          title: this.$t('exp.reserve.baseCurrency.amount'),
        ...
        {
          //发票操作类型
          title: this.$t('exp.invoice.operation.type'),
            ...
            return (
              <div>
                ...
                {value === 'BACK_LASE' && (
                  ...
                  >
                    {this.$t('exp.red.invoice.reserve')}
                  </a>
                )}
              </div>
            );
    ...
    return (
      <div>
        ...
        <ApprotionInfo
          ...
          visible={showApprotion}
          id={record.sourceReportLineId}
        />
      </div>
    );
  }

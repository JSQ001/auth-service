...
import NewUpdateBankAccount from 'containers/financial-management/supplier-management/approval-new-update-bank-account';
...
class SupplierBankAccount extends React.Component {
        ...
        },
        {
          ...
          render: (text, record, index) => (
            <span>
              ...
              {<a onClick={e => this.handleUpdate(e, record, index)}>审批</a>}
            </span>
          ),
        },
      ],
  ...
  handleBack = () => {
    ...
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/financial-management/approval-supplier/approval-supplier`,
      })
    );
  };

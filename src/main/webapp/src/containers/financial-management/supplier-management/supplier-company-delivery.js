  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        {
          /*公司代码*/
          title: this.$t('supplier.company.code'),
          key: 'companyCode',
        ...
        {
          /*公司名称*/
          title: this.$t('supplier.company.name'),
          key: 'name',
          dataIndex: 'name',
          render: desc => (
            <span>
        ...
        {
          /*账套*/
          title: this.$t('supplier.company.setOfBook'),
          key: 'setOfBooksName',
          dataIndex: 'setOfBooksName',
        },
        {
          /*启用*/
          title: this.$t('common.status.enable'),
          key: 'enabled',
          dataIndex: 'enabled',
          width: '10%',
    ...
    return (
      <div className="supplier-company-delivery" style={{ paddingBottom: 20 }}>
        ...
        <ListSelector
          ...
          extraParams={{ tenantId: this.props.company.tenantId, vendorInfoId: vendorInfo.id }}

...
class MyGLWorkOrder extends Component {
  ...
  getList = () => {
    ...
    let params = {
      ...
      employeeId: searchParams.employeeId ? searchParams.employeeId : null,
  ...
  handleMenuClick = value => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/my-gl-work-order/new-gl-work-order/${value.key}/${
  ...
  onTableRowClick = record => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/my-gl-work-order/my-gl-work-order-detail/${record.id}`,
      })
    );
  };
  /**
          ...
          <div className="table-header-buttons">
            <Row>
              <Col id="my-gl-work-order-drop" style={{ position: 'relative' }} span={18}>
                <Dropdown
                  getPopupContainer={() => document.getElementById('my-gl-work-order-drop')}
                  overlay={

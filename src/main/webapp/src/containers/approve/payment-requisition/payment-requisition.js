...
class PaymentRequisitionApprove extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      approvedPage: 0,
      approvedPageSize: 10,
      paymentRequisitionDetail:
        '/approval-management/payment-requisition/detail/:id/:entityOid/:flag', //
    };
  }
  ...
  handleRowClick = (record, flag) => {
    let path = this.state.paymentRequisitionDetail
...
export default connect(
  ...
  null,
  { withRef: true }
)(wrappedPaymentRequisitionApprove);

...
class CashTransactionClass extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        //   getUrl: `${config.mdataUrl}/api/setOfBooks/by/tenant`, method: 'get', labelKey: 'setOfBooksName', valueKey: 'id', getParams: {roleType: 'TENANT'}}, //账套
        {
          type: 'select',
          colSpan: 6,
          id: 'setOfBookId',
  ...
  componentWillMount() {
    baseService.getSetOfBooksByTenant().then(res => {
      ...
      let setOfBooksId = Number(this.props.match.params.setOfBooksId)
      ...
      searchParams.setOfBookId = setOfBooksId;
  ...
  clearEventHandle = () => {
    ...
    const setOfBookId = searchParams.setOfBookId
      ? searchParams.setOfBookId
      : this.props.company.setOfBooksId;
    searchForm[0].defaultValue = setOfBookId;
    this.setState(
      {
        searchParams: {
          setOfBookId,

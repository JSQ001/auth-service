...
class PaymentCompanySetting extends React.Component {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        },
        {
          ...
          colSpan: 6,
          id: 'companyCode',
          label: messages('paymentCompanySetting.companyCode'),
        },
        {
          type: 'input',
          colSpan: 6,
          id: 'companyName',
          label: messages('paymentCompanySetting.companyName'),
        },
        {
          type: 'value_list',
          colSpan: 6,
          id: 'ducumentCategory',
          label: messages('paymentCompanySetting.ducumentCategory'),
          options: [],
          valueListCode: 2106,
        },
      ],
  ...
  getList() {
    ...
    params.companyCode = this.state.searchParams.companyCode
      ? this.state.searchParams.companyCode
      : '';
    params.companyName = this.state.searchParams.companyName
      ? this.state.searchParams.companyName
      : '';
    params.ducumentCategory = this.state.searchParams.ducumentCategory
      ? this.state.searchParams.ducumentCategory
      : '';
    params.size = this.state.pageSize;
    params.page = this.state.page;
    paymentCompanySettingService
  ...
  deleteShowSlide = () => {
    ...
    paymentCompanySettingService
      .deletePaymentCompanySetting(data)
      .then(req => {
  ...
  render() {
    ...
    return (
      <div className="payment-method">
        ...
        <div className="table-header">
          <div className="table-header-buttons">
            ...
            <Popconfirm
              ...
              onConfirm={this.deleteShowSlide}
        ...
        <SlideFrame
          title={
            this.state.updateParams.isNew
              ? messages('paymentCompanySetting.newPaymentCompanySetting')
              : messages('paymentCompanySetting.editPaymentCompanySetting')
          }
          show={showSlideFrameNew}
          afterClose={this.handleCloseNewSlide}
          onClose={() => this.showSlideNew(false)}
        >
          <NewPaymentCompanySetting
            onClose={e => this.showSlideNew(e)}

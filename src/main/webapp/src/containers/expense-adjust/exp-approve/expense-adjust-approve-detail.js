...
class ExpenseAdjustApproveDetail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      rejectLoading: false,
      headerData: {},
      expenseAdjust: '/approval-management/approve-expense-adjust/approve-expense-adjust',
    };
  }
  ...
  onCancel = () => {
    this.props.dispatch(
      routerRedux.replace({
        pathname: '/approval-management/approve-expense-adjust/approve-expense-adjust',
      })
    );
  };
  //通过
  ...
  render() {
    ...
    return (
      <div
        className="expense-adjust-detail"
        style={{
          boxShadow: 'rgba(0, 0, 0, 0.15) 0px 2px 8px',
          paddingCottom: 100,
        }}
      >
        <ExpenseAdjustApproveCommon
        ...
        {isConfirm && (
          <Affix offsetBottom={0} className="bottom-bar-jsq">
            <Button onClick={this.onCancel} className="back-btn" style={{ marginLeft: 15 }}>
...
export default connect(
  ...
  null,
  { withRef: true }
)(wrappedExpenseAdjustApproveDetail);

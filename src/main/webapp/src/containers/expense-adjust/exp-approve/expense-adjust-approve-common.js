...
class ExpenseAdjustApproveCommon extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      voucherColumns: [
        ...
        {
          //凭证日期
          title: this.$t('accounting.view.accountingDate'),
          align: 'center',
          dataIndex: '3',
          key: '3',
          width: 62,
      ...
      columns: [
        ...
        {
          title: this.$t('customField.base.amount'),
      ...
      subTabsList: [{ label: this.$t('common.detail'), key: 'DETAIL' }],
      data: [],
      planAmount: 0,
      pageSize: 10,
      page: 0,
      ...
      ExpenseAdjustDetail:
        '/approval-management/approve-expense-adjust/expense-adjust-approve-detail/',
  ...
  getExpenseType = () => {
    adjustService
      .getExpenseAdjustTypeById(this.props.expenseAdjustTypeId)
      .then(res => {
  ...
  getDimension = () => {
    ...
    adjustService.getDimensionAndValue(this.props.id).then(response => {
      ...
      let documentParams = {
        ...
        infoList: [
          ...
          { label: this.$t('common.department'), value: response.data.unitName },
          {
            ...
            value:
              response.data.adjustTypeCategory === '1001'
  ...
  renderContent = () => {
    ...
    return (
      <div className="adjust-content" style={{ marginBottom: 50, paddingBottom: 30 }}>
        ...
        <div
          className="expense-adjust-detail-center"
          style={{
            boxShadow: 'rgba(0, 0, 0, 0.15) 0px 2px 8px',
        ...
        >
          ...
          >
            <div
              ...
              style={{ color: 'black', fontSize: 17, borderBottom: '1px solid #ececec' }}
            >
        ...
        <div
          ...
          style={flag ? { margin: '20px 15px 35px 15px' } : { margin: '20px 15px 20px 15px' }}
        >
...
export default connect(
  ...
  null,
  { withRef: true }
)(wrappedExpenseAdjustApproveCommon);

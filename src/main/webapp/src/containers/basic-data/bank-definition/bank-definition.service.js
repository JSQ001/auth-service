...
export default {
  ...
  importSelfBank: function(file) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.mdataUrl + '/api/bank/infos/import/custom/bank/info', file)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  exportSelfBank: function(result, ps, exportParams) {
    let url =
      config.mdataUrl +
      '/api/bank/infos/export/custom/bank/info/new?page=' +
      ps.page +
      '&size=' +
      ps.size;
  ...
  downloadSelfBankTemp: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.mdataUrl + '/api/bank/infos/custom/bank/info/template',
          {},
          {},
          { responseType: 'arraybuffer' }
        )

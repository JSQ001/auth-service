...
class BankDefinition extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        //   //defaultValue:'中国',
        //   getUrl: config.mdataUrl + '/api/localization/query/country',
        //   method: 'get',
  ...
  getList() {
    ...
    if (params.countryCode && params.countryCode[0]) {
  ...
  handleImportOk = transactionID => {
    httpFetch
      .post(`${config.mdataUrl}/api/bank/infos/import/new/confirm/${transactionID}`)
      .then(res => {
        if (res.status === 200) {
          this.getList();
        }
    ...
    return (
      <div className="budget-bank-definition">
        ...
        <ImporterNew
          ...
          templateUrl={`${config.mdataUrl}/api/bank/infos/custom/bank/info/template`}
          uploadUrl={`${config.mdataUrl}/api/bank/infos/import/custom/bank/info/new`}
          errorUrl={`${config.mdataUrl}/api/bank/infos/import/new/error/export`}
          errorDataQueryUrl={`${config.mdataUrl}/api/bank/infos/import/new/query/result`}
          deleteDataUrl={`${config.mdataUrl}/api/bank/infos/import/new/delete`}

  ...
  constructor(props) {
    ...
    this.state = {
      ...
      selectListCurrencyCode: {
        url: config.mdataUrl + '/api/currency/rate/company/standard/currency/getAll/companyOid?',
      ...
      .then(res => {
        ...
        this.props.dispatch(
          routerRedux.replace({
            ...
            }/${this.props.match.params.companyId}/${this.props.match.params.setOfBooksId}`,
          })
        );
      })
      .catch(err => {

...
export default {
  ...
  createLegalPerson(object) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.mdataUrl + '/api/company/receipted/invoice', object)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  updateLegalPerson(object) {
    return new Promise((resolve, reject) => {
      httpFetch
        .put(config.mdataUrl + '/api/company/receipted/invoice', object)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getLegalPersonDetail(oid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/company/receipted/invoices/users/' + oid)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getLegalPersonCompanys(params) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/company/by/legalentity', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  importPersonsToLegalPerson(companyReceiptedOid, userOids) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(
          config.mdataUrl + '/api/company/receipted/invoice/associate/' + companyReceiptedOid,
          userOids
        )
        .then(res => {
          resolve(res);
  ...
  movePersonsToLegalPerson(params) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .put(config.mdataUrl + '/api/company/receipted/invoice/move', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getLegalList(params) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/v2/my/company/receipted/invoices?isAll=true', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {

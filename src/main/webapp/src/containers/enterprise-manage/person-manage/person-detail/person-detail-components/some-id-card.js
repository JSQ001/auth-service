    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        let card = Object.assign(this.state.card, {
          ...
          enable: !!this.state.card.enabled,
        });
            ...
            <Form onSubmit={this.addCard} onChange={this.handleFormChange}>
              ...
              >
                {getFieldDecorator('cardExpiredTime', {
                  ...
                  rules: [],
                })(<DatePicker format={'YYYY-MM-DD'} onChange={this.handleCardTimeChange} />)}
              </FormItem>
              {/*状态*/}
              ...
              >
                {getFieldDecorator('primary', {
                  ...
                  <Checkbox onChange={this.handleCardDefaultChange}>
                    {/*是（只能有一个默认）*/}

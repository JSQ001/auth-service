...
class PersonBasicInfo extends React.Component {
        ...
        if (this.state.personObj.userOid) {
          ...
          let personObj = Object.assign(
            {},
            {
              ...
              countryCode:
                values.mobilePrefix && values.mobilePrefix.split('$$').length > 1
  ...
  handleCancel = e => {
    ...
    if (!this.state.personObj.userOid) {
      this.props.dispatch(
        routerRedux.replace({
          pathname: `/setting/employee/employee`,
        })
      );
    }
  };
  ...
  renderNoEditingTextGender = text => {
    if (text != null && this.state.genderData != null) {
      return this.state.genderData[text] && this.state.genderData[text].name;
    } else {
      return '';
    }
  };
            ...
            <Col span={8}>
              ...
              >
                {getFieldDecorator('mobile', {
                  initialValue: personObj.mobile ? personObj.mobile.split(' ')[1] : '',
                  rules: [
                    {
                      max: 30,
              ...
              >
                {getFieldDecorator('directManager', {
                  ...
                  <Chooser
                    ...
                    onChange={this.handleChange}
                    type="user"
                    listExtraParams={{ currentUserOid: personObj.userOid }}
                  />
                )}
              </FormItem>
            </Col>
            ...
            <Col span={8}>
              ...
              >
                {getFieldDecorator('birthday', {
                  initialValue: personObj.id
                    ? personObj.birthday && moment(personObj.birthday)
                    : null,
                  rules: [],
            ...
            <Col span={8}>
              ...
              >
                {getFieldDecorator('entryDate', {
                  initialValue: personObj.id
                    ? personObj.entryDate && moment(personObj.entryDate)
                    : null,
                  rules: [],
                })(<DatePicker format={'YYYY-MM-DD'} onChange={this.handleChange} />)}
              </FormItem>

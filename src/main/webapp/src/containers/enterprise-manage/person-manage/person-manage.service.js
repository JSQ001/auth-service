...
export default {
  ...
  downloadBankAccountTemplate: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.mdataUrl + '/api/contact/bank/accounts/template/export',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
  ...
  downloadCardAccountTemplate: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.mdataUrl + '/api/contact/cards/template/export',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
  ...
  importEmployeeNew: function(file) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.mdataUrl + '/api/refactor/users/v2/info/import', file)
        .then(res => {
          resolve(res);
        })
        .catch(err => {

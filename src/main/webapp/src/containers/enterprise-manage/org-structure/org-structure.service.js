...
export default {
  ...
  getTenantAllDepRes() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/departments/root/v2?flag=1001')
        .then(res => {
          resolve(res);
          //不在这里写逻辑，其他地方服务复用
        })
  ...
  getChildDepByDepOidRes(Dep, flag) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/department/child/' + Dep.departmentOid + '/?flag=' + _flag)
        .then(res => {
          resolve(res);
          //不在这里写逻辑，其他地方服务复用
        })
  ...
  getDepDetailByDepOid(Dep) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/departments/' + Dep.departmentOid)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getDepUserByDepOid(Dep, params) {
    ...
    // params = {page,size}
    // return new Promise((resolve, reject) => {
    //   httpFetch.get(config.mdataUrl + '/api/departments/users/' + Dep.departmentOid, params)
    //     .then((res) => {
    //       resolve(res)
    //     })
    //     .catch((err) => {
  ...
  searchDep(keyWord) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/department/like', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  searchDepOrPersonV2(keyWord) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/department/user/keyword', params)
        .then(response => {
  ...
  disabledDep(depOid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .put(config.mdataUrl + '/api/department/disable/' + depOid)
        .then(res => {
  ...
  enabledDep(depOid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .put(config.mdataUrl + '/api/department/enable/' + depOid)
        .then(res => {
  ...
  deleteDep(depOid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .delete(config.mdataUrl + '/api/department/delete/' + depOid)
        .then(res => {
  ...
  createChildDep(data, treeNode) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.mdataUrl + '/api/departments/', data)
        .then(res => {
  ...
  updateDep(dep) {
    return new Promise((resolve, reject) => {
      httpFetch
        .put(config.mdataUrl + '/api/departments', dep)
        .then(res => {
  ...
  batchMovePerson(params) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .put(config.mdataUrl + '/api/departments/change/list', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  searchPersonInDep(params) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/users/v3/search', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getTenantAllDepResV2() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/department/tenant/all')
        .then(res => {
          resolve(res);
          //不在这里写逻辑，其他地方服务复用
        })
  ...
  getRoleList(params) {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.mdataUrl + '/api/departmentposition/page', params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  createUpdateRole(role) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.mdataUrl + '/api/departmentposition', role)
        .then(res => {
          resolve(res);
        })
        .catch(err => {

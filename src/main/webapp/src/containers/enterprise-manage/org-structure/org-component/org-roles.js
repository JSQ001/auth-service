...
class OrgStructureRoles extends React.Component {
  ...
  // 跳转到责任中心配置
  detailClick = (e, departmentId, departmentOid) => {
    this.props.dispatch(
      routerRedux.replace({
        //部门id
        pathname: `/enterprise-manage/org-structure/responsibility-configuration/${departmentId}/${departmentOid}`,
      })
    );
  };
  render() {
    ...
    if (this.state.editing) {
      rolesTitleWrap = (
        <div className="f-left">
          ...
          <input
            ...
            disabled={!!this.state.selectedKeysDepDataByApi.departmentCode}
            value={
      ...
      rolesTitleWrap = (
        <div className="f-left">
          ...
          <div className="f-left" style={{ margin: '0 112px 0 8px', color: 'black' }}>
          ...
          <div className="f-left " style={{ margin: '0 10px 0 8px', color: 'black' }}>
          ...
          <div className="f-left">
            ...
            <a
              ...
              onClick={e =>
                this.detailClick(
                  e,
                  this.state.selectedKeysDepDataByApi.id,
      ...
      <div className="org-structure-roles">
        <div className="roles-title-wrap">
          ...
          <div className="f-right">
            {this.renderRoleMoreMeunByRole(this.props.selectedKeysDepData)}
          </div>
          <div className="clear" />
        </div>
        {rolesWrap}

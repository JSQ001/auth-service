  ...
  handleSave = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        httpFetch
          .post(`${config.budgetUrl}/api/budget/control/strategies`, values)
          .then(res => {
            if (res.status === 200) {
      ...
      <div className="new-budget-strategy">
        <Form onSubmit={this.handleSave} style={{ width: '55%', margin: '0 auto' }}>
          ...
          <FormItem wrapperCol={{ offset: 7 }}>
            ...
            <Button onClick={this.handleCancel} style={{ marginLeft: 20 }} className="btn-cancel">

...
export default {
  ...
  filterItemByGroupIdAndOrganizationId(groupId, organizationId) {
    return httpFetch.get(
      `${
        config.budgetUrl
      }/api/budget/groupDetail/${groupId}/query/filterAll?organizationId=${organizationId}`
    );
  },
  ...
  getItemByGroupId(groupId, page, size) {
    return httpFetch.get(
      `${config.budgetUrl}/api/budget/groupDetail/${groupId}/query?page=${page}&size=${size}`
    );
  },
  ...
  batchDeleteItemFromGroup(groupId, itemList) {
    return httpFetch.delete(
      `${config.budgetUrl}/api/budget/groupDetail/${groupId}/batch`,
      itemList
    );
  },

  ...
  constructor(props) {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        {
          type: 'select',
          id: 'controlRuleCodeFrom',
          label: this.$t({ id: 'budget.controlRulesFrom' }),
          options: [],
          labelKey: 'controlRuleName',
          valueKey: 'controlRuleCode',
          getUrl: `${config.budgetUrl}/api/budget/control/rules/query/all`,
          method: 'get',
        ...
        {
          type: 'select',
          id: 'controlRuleCodeTo',
          label: this.$t({ id: 'budget.controlRulesTo' }),
          options: [],
          labelKey: 'controlRuleName',
          valueKey: 'controlRuleCode',
          getUrl: `${config.budgetUrl}/api/budget/control/rules/query/all`,
        ...
        /*优先级*/
        {
          type: 'select',
          id: 'priority',
          label: this.$t({ id: 'budget.controlRules.priority' }),
          options: [],
          labelKey: 'priority',
          valueKey: 'priority',
          getUrl: `${config.budgetUrl}/api/budget/control/rules/query/all`,

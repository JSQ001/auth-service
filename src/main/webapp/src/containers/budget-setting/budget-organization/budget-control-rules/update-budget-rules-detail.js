      ...
      if (!err) {
        ...
        budgetService
          ...
          .catch(e => {
            if (e.response) {
              message.error(
                `${this.$t({ id: 'common.create.filed' })}, ${e.response.data.message}`
              );
            }
    ...
    this.setState({
      filtrateMethodHelp:
        value === 'INCLUDE'
          ...
          : value === 'EXCLUDE'
            ? this.$t('budget.filtrateMethodHelp.exclude')
            : this.$t('common.please.select') /*值范围为开区间，不包含左右边界值*/,
            ...
            <Col span={20}>
              ...
              >
                {getFieldDecorator('ruleParameter', {
                  initialValue:
                    ruleParamDetail.ruleParameterType === 'BGT_RULE_PARAMETER_DIM'
                      ? ruleParamDetail.ruleParameterDescription
                      : ruleParamDetail.ruleParameter,
                  rules: [
                    {
                      required: true,
                      message: this.$t({ id: 'common.please.select' }),
            ...
            <Col span={20}>
              ...
              >
                {getFieldDecorator('invalidDate', {
                  initialValue: ruleParamDetail.invalidDate
                    ? moment(ruleParamDetail.invalidDate, 'YYYY-MM-DD')
                    : null,
...
export default connect(
  ...
  null,
  { withRef: true }
)(WrappedUpdateBudgetRulesDetail);

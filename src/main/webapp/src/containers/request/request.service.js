...
export default {
  ...
  getDocumentType(formType) {
    return httpFetch.get(
      `${config.baseUrl}/api/custom/forms/company/my/available/all/?formType=${formType}`
    );
  },
  ...
  getBookerTaskRequestDetail(Oid, bookTaskOid) {
    return httpFetch.get(
      `${config.baseUrl}/api/book/task/my/get/${Oid}?travelOperationRecordOid=${bookTaskOid}`
    );
  },
  ...
  getLoanRepayment(page, size, Oid) {
    return httpFetch.get(
      `${config.baseUrl}/api/repayment/list?page=${page}&size=${size}&loanApplicationOid=${Oid}`
    );
  },
  // 新增供应商
  addData(data) {
    return httpFetch.post(`${config.mdataUrl}/api/ven/infobank/insert`, data);
  },
  // 新增银行卡
  addNewAccount(data) {
    return httpFetch.post(`${config.mdataUrl}/api/ven/bank/insert`, data);
  },
  //根据表单Oid获取申请单类型
  getFormType(Oid) {
  ...
  getVenMasterInfo(params) {
    return httpFetch.get(`${config.mdataUrl}/api/ven/info/search`, params);
  },

  //根据收款人id获取收款账号
  getAccountInfo(id) {
    return httpFetch.get(config.mdataUrl + '/api/ven/infoBank?vendorInfoId=' + id);
  },
  ...
  saveJDRequest(params) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(`${config.baseUrl}/api/jingdong/order/applications/draft`, params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  submitJDRequest(params) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(`${config.baseUrl}/api/jingdong/order/applications/custom/form/submit`, params)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getDestinationByKeywork(keyword) {
    return httpFetch.get(
      `${config.baseUrl}/api/city/search/${keyword}?page=0&size=10&useType=FLIGHT`
    );
  },
  ...
  handleBoardingConfirmation(applicationOid, comment, flag, travelOrderOids) {
    let url = `${
      config.baseUrl
    }/api/travel/operation/confirm?applicationOid=${applicationOid}&flag=${flag}&travelOrderOids=${travelOrderOids}`;
  ...
  judgeEnableChange(applicationOid) {
    return httpFetch.get(
      `${config.baseUrl}/api/travel/application/change/enable?lastApplicationOid=${applicationOid}`
    );
  },
  ...
  handleApplicationUpload(applicationOid, params) {
    return httpFetch.post(
      `${config.baseUrl}/api/travel/applications/draft/${applicationOid}`,
      params
    );
  },
  ...
  printTravelApplication(applicationOid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(`${config.baseUrl}/api/travel/application/generate/pdf/${applicationOid}`)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  printLoanApplication(applicationOid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(`${config.baseUrl}/api/loan/application/generate/pdf/${applicationOid}`)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  printExpenseApplication(applicationOid) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(`${config.baseUrl}/api/expense/application/generate/pdf/${applicationOid}`)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .post(
          `${
            config.baseUrl
          }/api/applications/close?applicationOid=${applicationOid}&participantOid=${participantOid}`
        )
        .then(res => {
          resolve(res);
        })
    ...
    return new Promise((resolve, reject) => {
      httpFetch
        .post(
          `${
            config.baseUrl
          }/api/applications/restart?applicationOid=${applicationOid}&participantOid=${participantOid}&closeDay=${closeDay}`
        )
        .then(res => {
          resolve(res);
        })
  ...
  getLoanDefaultRelativeApplication(formOid) {
    ...
    return httpFetch.post(
      `${config.baseUrl}/api/loan/reference/my/application/default?formOid=${formOid}`,
      params
    );
  },
  ...
  getPayee(page, size, keyword) {
    return httpFetch.get(
      `${config.mdataUrl}/api/search/users/entire?page=${page}&size=${size}&keyword=${keyword}`
    );
  },
  ...
  getProxyApplicantList(formType) {
    return httpFetch.get(
      `${config.baseUrl}/api/bill/proxy/query/my/principals?formType=${formType}`
    );
  },
};

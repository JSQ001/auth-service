...
class ContractDetailCommon extends React.Component {
          ...
          infoList: [
            { label: this.$t('my.contract.number'), value: response.data.contractNumber },
            {
              ...
              value:
                ...
                response.data.employee.fullName + '-' + response.data.employee.employeeCode,
            },
  ...
  render() {
    const { detailLoading, planLoading, documentParams, columns, headerData } = this.state;
    ...
    return (
      <div className="contract-detail" style={{}}>
        ...
        <div>
          ...
          >
            <ApproveHistory ApproveHistory type="801004" oid={headerData.documentOid} />
          </Card>
        </div>
      </div>
    );

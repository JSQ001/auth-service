...
class Contract extends React.Component {
  ...
  unapprovedSearch = values => {
    ...
    this.setState(
      {
        unApproveSearchParams: { ...this.state.unApproveSearchParams, ...values },
        approveSearchParams: { ...this.state.unApproveSearchParams, ...values },
      },
      () => {
  ...
  approvedSearch = values => {
    ...
    this.setState(
      {
        approveSearchParams: { ...this.state.approveSearchParams, ...values },
        unApproveSearchParams: { ...this.state.approveSearchParams, ...values },
      },
      () => {
  ...
  handleRowClick = record => {
    ...
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/contract-manager/contract-recheck/contract-detail/${record.id}/${
          this.state.tabValue
        }`,
      })
    );
  ...
  searchNumber = e => {
    ...
    this.setState({ unApproveSearchParams, approveSearchParams }, () => {
      if (this.state.tabValue === 'unapproved') {
        ...
        this.customTable2 && this.customTable2.search(approveSearchParams);
      }
    });
  };
  ...
  renderContent() {
    const { tabValue, SearchForm1, columns, columns2 } = this.state;

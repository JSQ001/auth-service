  ...
  /*handlePartnerCategory = (value) =>{
    ...
    if(value){
      ...
      if(value.key === 'EMPLOYEE'){
        ...
        partner.url = `${config.mdataUrl}/api/select/user/by/name/or/code/and/company`;
        ...
        <Form onSubmit={this.handleSave}>
          ...
          <FormItem {...formItemLayout} label={this.$t('my.contract.partner.category')}>
            {getFieldDecorator('partnerCategory', {
              ...
              >
                {partnerCategoryOptions.map(item => <Option key={item.value}>{item.name}</Option>)}
              </Select>
            )}
          </FormItem>
          ...
          <FormItem {...formItemLayout} label={this.$t('my.contract.responsible.person')}>
            {getFieldDecorator('employeeId', {
              initialValue:
                headerData.contractName && headerData.employee && headerData.employeeId
                  ? [
                      {

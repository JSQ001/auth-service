            ...
            <Row>
              ...
              <Col span={18} className="invoice-brief-content-area" stlye={{ float: 'right' }}>
                <div className="invoice-type">
                  {invoice.type}
                  {
                    <Button icon="edit" type="primary" onClick={this.handleEdit}>
                      修改
                    </Button>
                  }
                  {
                ...
                <Row className="invoice-brief-content" gutter={10}>
                  {
                    <Col span={12}>
                      ...
                      {(invoice.billingTime
                        ? new Date(invoice.billingTime * 1000)
                        : new Date()
                      ).format('yyyy-MM-dd')}
                    </Col>
                  }
            ...
            <div className="invoice-detail-area">
              ...
              <Row className="invoice-row">
                ...
                <Col span={20} className="invoice-detail">
                  ...
                  (金额合计：{(invoice.feeWithoutTax / 100).toFixed(2)} 税额合计：{(
                    (invoice.tax || 0) / 100
                  ).toFixed(2)})
                </Col>
              </Row>

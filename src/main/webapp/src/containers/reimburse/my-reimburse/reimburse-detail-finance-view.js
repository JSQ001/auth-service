...
import ReimburseDetailCommon from 'containers/reimburse/my-reimburse/reimburse-detail-common-finance-view';
...
class ReimburseDetail extends React.Component {
  ...
  onCancel = () => {
    ...
    const pathname = `/financial-view/public-reimburse-report/public-reimburse-report`;
    this.props.dispatch(
      routerRedux.push({
        pathname,
      })

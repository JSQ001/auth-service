...
class ReimburseDetail extends React.Component {
  ...
  onCancel = () => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/approval-management/approval-my-reimburse/approval-my-reimburse`,
      })
    );
  };
  ...
  render() {
    ...
    return (
      <div style={{ paddingBottom: 100 }}>
        ...
        />
        {this.props.match.params.type === 'unapproved' ? (
          <div className="bottom-bar bottom-bar-approve">
            <ApproveBar
              passLoading={loading}
              style={{ paddingLeft: 20 }}
              backUrl={'/approval-management/approval-my-reimburse/approval-my-reimburse'}

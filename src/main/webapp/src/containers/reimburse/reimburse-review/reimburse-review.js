...
class ReimburseReview extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      invoiceColumns: [
        {
          /*序号*/
          title: this.$t({ id: 'myReimburse.index' }),
          dataIndex: 'index',
          width: 50,
          render: (recode, value, index) => <span>{index + 1}</span>,
        },
        {
          /*单号*/
          title: this.$t({ id: 'myReimburse.businessCode' }),
        ...
        {
          /*申请人*/
          title: this.$t({ id: 'myReimburse.applicationName' }),
        ...
        {
          /*事由*/
          title: this.$t({ id: 'myReimburse.remark' }),
          dataIndex: 'remark',
          render: recode => <Popover content={recode}>{recode}</Popover>,
        },
        {
          /*币种*/
          title: this.$t({ id: 'myReimburse.currencyCode' }),
        ...
        {
          /*金额*/
          title: this.$t({ id: 'myReimburse.totalAmount' }),
        ...
        {
          /*本币金额*/
          title: this.$t({ id: 'myReimburse.functionalAmount' }),
      ...
      tabs: [{ key: 'prending_audit', name: '待审核' }, { key: 'audit_pass', name: '已审核' }],
      searchParams: {
        applicationId: null,
        corporationOids: [],
        dateTo: undefined,
  ...
  getList = () => {
    ...
    httpFetch
      .get(`${config.baseUrl}/api/expReport/recheck`, params)
      .then(res => {
        this.setState({
          loading: false,
          data: res.data,
  ...
  handleRowClick = record => {
    ...
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/financial-management/reimburse-review/reimburse-detail/${
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Table
          columns={nowType === 'NOT_AUDITED' ? invoiceColumns : borrowColumns}
          dataSource={data}
          bordered
          scroll={{ x: 1300 }}

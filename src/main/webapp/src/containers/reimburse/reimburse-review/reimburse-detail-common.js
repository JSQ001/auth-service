...
class ReimburseReviewDetailCommon extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      subTabsList: [{ label: '详情', key: 'DETAIL' }],
      columns: [
        {
      ...
      return (
        <div className="list-info">
          ...
          <span className="content">
            <a onClick={this.reimburseDetail()}>{value}</a>
          </span>
        </div>
      );
    } else {
        ...
        >
          <div style={{ paddingTop: 0, marginTop: '-20px' }}>
            <h3
              ...
              style={{ borderBottom: '1px solid #ececec', height: 46, marginTop: 10 }}
            >
              {headerData.formName}
            </h3>
            <Row>
                ...
                <Row>
                  <Col span={8}>
                    <div className="list-info">
                      ...
                      <span className="content">
                        {headerData.applicationName + '-' + headerData.applicationId}
                      </span>
                    </div>
                  </Col>
                  <Col span={8}>
                  ...
                  <Col span={16}>
                    <div className="list-info">
                      ...
                      <span className="content">
                        <a
                          onClick={() => {
                            this.reimburseDetail(headerData);
                          }}
                        >
                          {headerData.businessCode}
                        </a>
                      </span>
                    </div>
                  </Col>
              ...
              <Col span={9}>
                ...
                <div style={{ float: 'right', marginRight: '50px' }}>
                  <div className="status-title">
                    {this.$t({ id: 'common.column.status' } /*状态*/)}
                  </div>
                  <div className="status-content">
                    {contractStatus[headerData.reportStatus]
                      ? contractStatus[headerData.reportStatus].label
                      : ''}
                  </div>
                </div>
              </Col>
            ...
            {headerData.relatedContract && (
              <Row>
                <Col span={24}>
                  <span>合同：</span>
                  <a onClick={this.contractDetail}>
                    {headerData.contractHeaderLineDTO.contractNumber}
                  </a>
                  <span style={{ marginLeft: 10 }}>
                    总金额：{headerData.currencyCode}{' '}
                    {headerData.contractHeaderLineDTO.contractAmount}
                  </span>
                </Col>
              </Row>
            )}

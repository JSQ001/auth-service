...
export default {
  ...
  getImporterInfo(page, size) {
    return httpFetch.get(
      `${config.budgetUrl}/api/budget/reserve/adjust/import/data?page=${page}&size=${size}`
    );
  },
  ...
  newOccupancy(params) {
    return httpFetch.post(
      `${config.budgetUrl}/api/budget/reserve/adjust/import/final/confirmation`,
      params
    );
  },
  ...
  getImporterList(page, size, batchNumber) {
    return httpFetch.get(
      `${
        config.budgetUrl
      }/api/budget/reserve/adjust/import/ajust/data?page=${page}&size=${size}&batchNumber=${batchNumber}`
    );
  },
};

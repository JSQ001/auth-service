...
export default {
  ...
  exportBalance(params) {
    return httpFetch.post(
      `${config.budgetUrl}/api/budget/balance/query/results/export`,
      params,
      {},
  ...
  exportDetail(params) {
    return httpFetch.post(
      `${config.budgetUrl}/api/budget/balance/query/results/detail/export`,
      params,
      {},
      { responseType: 'arraybuffer' }
    );
  ...
  queryAllStructures(structureId) {
    return httpFetch.get(
      `${config.budgetUrl}/api/budget/structure/assign/layouts/queryAll?structureId=${structureId}`
    );
  },
  /**
   * 查询所有参数
  ...
  queryResults(page, size, id) {
    return httpFetch.get(
      `${config.budgetUrl}/api/budget/balance/query/results/${id}?page=${page}&size=${size}`
    );
  },
};

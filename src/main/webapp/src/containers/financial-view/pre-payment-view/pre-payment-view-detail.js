...
import PrePaymentCommon from 'containers/pre-payment/my-pre-payment/pre-payment-common-financial';
...
class PrePaymentDetail extends React.Component {
  ...
  onCancel = () => {
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/financial-view/pre-payment-view/pre-payment-view`,
      })
    );
  };
        ...
        {this.props.match.params.status === 'unapproved' ? (
          <div className="bottom-bar bottom-bar-approve">
            <ApproveBar
              ...
              backUrl={'/approval-management/pre-payment-approve/pre-payment-approve'}

...
class ExpenseAdjustDetail extends React.Component {
  ...
  onCancel = () => {
    this.props.dispatch(
      routerRedux.push({ pathname: '/financial-view/expense-adjust-view/expense-adjust-view' })
    );
  };
  ...
  handleHeadEdit = () => {
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/expense-adjust/my-expense-adjust/edit-expense-adjust/${
          this.state.headerData.id
    ...
    return (
      <div className="adjust-content" style={{ marginBottom: 50, paddingBottom: 20 }}>
        ...
        <div style={{ marginTop: 20, marginBottom: 0, boxShadow: '0 2px 8px rgba(0, 0, 0, 0.15)' }}>
          ...
          <ApproveHistory type="801006" oid={headerData.documentOid} />
        </div>
        <ApprotionInfo
          close={() => {

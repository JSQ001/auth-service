...
class SetOfBooks extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        {
          title: this.$t('set-of-books.code'),
          dataIndex: 'setOfBooksCode',
          width: 150,
          align: 'left',
        },
        {
          title: this.$t('set-of-books.name'),
          dataIndex: 'setOfBooksName',
          width: 150,
          align: 'left',
        },
        {
          title: this.$t('set-of-books.period.set.code'),
        ...
        {
          title: this.$t('set-of-books.account.set.code'),
  ...
  getList() {
    ...
    let url = `${config.mdataUrl}/api/setOfBooks/query/dto`;

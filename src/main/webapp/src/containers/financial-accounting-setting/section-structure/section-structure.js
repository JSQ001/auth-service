    ...
    this.state = {
      ...
      searchForm: [
        ...
        },
        {
          ...
          type: 'input',
          id: 'segmentSetCode',
          label: this.$t({ id: 'section.structure.code' }),
        },
        {
          //科目段结构名称
          type: 'input',
      ...
      columns: [
        ...
        {
          /*科目段结构代码*/
          title: this.$t({ id: 'section.structure.code' }),
          key: 'segmentSetCode',
          dataIndex: 'segmentSetCode',
        },
        {
          /*科目段结构名称*/
          title: this.$t({ id: 'section.structure.name' }),
          key: 'segmentSetName',
          dataIndex: 'segmentSetName',
          render: description => (
            <span>
        ...
        },
        {
          ...
          render: (text, record, index) => (
            <span>
              ...
              <a onClick={e => this.handleLinkSetting(e, record, index)}>
                {this.$t({ id: 'section.setting' })}
              </a>
            </span>
          ),
        },

...
class SectionMappingSet extends React.Component {
  ...
  handleImportOk = transactionID => {
    httpFetch
      .post(
        `${config.accountingUrl}/api/general/ledger/segment/map/import/new/confirm/${transactionID}`
      )
      .then(res => {
        if (res.status === 200) {
          this.getList();
        ...
        <div className="table-header">
          ...
          <div className="table-header-buttons">
            ...
            <ImporterNew
              ...
              }/api/general/ledger/segment/map/import/new?segmentId=${this.props.params.id}`}
              errorUrl={`${
                config.accountingUrl
              }/api/general/ledger/segment/map/import/new/error/export`}
              errorDataQueryUrl={`${
                config.accountingUrl
              }/api/general/ledger/segment/map/import/new/query/result`}
              deleteDataUrl={`${
                config.accountingUrl
              }/api/general/ledger/segment/map/import/new/delete`}

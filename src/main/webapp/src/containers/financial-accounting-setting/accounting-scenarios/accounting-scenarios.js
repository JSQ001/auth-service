...
class AccountingScenarios extends React.Component {
      ...
      searchForm: [
        {
          type: 'select',
          id: 'setOfBooksId',
          label: this.$t({ id: 'section.setOfBook' }),
          options: [],
          labelKey: 'setOfBooksName',
          valueKey: 'id',
          defaultValue: this.props.company.setOfBooksId,
          //getUrl:`${config.mdataUrl}/api/setOfBooks/by/tenant`, method: 'get', getParams: {roleType: 'TENANT'},
          event: 'SOB',
          isRequired: true,
        },
        {
          //核算场景代码
          type: 'input',
          id: 'transactionSceneCode',
          label: this.$t({ id: 'accounting.scenarios.code' }),
        },
        {
          //核算场景名称
          type: 'input',
          id: 'transactionSceneName',
          label: this.$t({ id: 'accounting.scenarios.name' }),
        },
      ],
      columns: [
        {
          /*账套*/
          title: this.$t({ id: 'section.setOfBook' }),
          key: 'setOfBooksName',
          dataIndex: 'setOfBooksName',
        },
        {
          /*核算场景代码*/
          title: this.$t({ id: 'accounting.scenarios.code' }),
          key: 'transactionSceneCode',
          dataIndex: 'transactionSceneCode',
        },
        {
          /*核算场景名称*/
          title: this.$t({ id: 'accounting.scenarios.name' }),
          key: 'transactionSceneName',
          dataIndex: 'transactionSceneName',
        },
        {
          /*状态*/
        ...
        },
        {
          ...
          render: (text, record, index) => (
            <span>
              ...
              <a onClick={e => this.handleLinkConfig(e, record, index)}>
                {this.$t({ id: 'accounting.configuration.set' })}
              </a>
            </span>
          ),
        },
  ...
  componentDidMount() {
    ...
    if (
      ...
      this.props.match.params.setOfBooksId !== ':setOfBooksId'
    ) {
      debugger;
      ...
      <div className="accounting-scenarios-system">
        ...
        <div className="table-header">
          ...
          <div className="table-header-buttons">
            <Button type="primary" onClick={() => this.setState({ scenariosVisible: true })}>
        ...
        >
          <NewUpdateScenariosSystem onClose={this.handleAfterClose} params={lov.params} />
        </SlideFrame>
      </div>
    );
  }

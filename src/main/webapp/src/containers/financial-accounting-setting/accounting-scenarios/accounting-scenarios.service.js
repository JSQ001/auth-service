...
export default {
  ...
  getScenariosSob(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/generalLedgerSceneMapping/selectByInput`,
      params
    );
  },
  ...
  addOrUpdateScenarios(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/generalLedgerSceneMapping/insertOrUpdate`,
      params
    );
  },
  ...
  getScenarioNotInSob(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/generalLedgerSceneMapping/select/unassigned/scene`,
      params
    );
  },
  ...
  getElementsGroupNotNull(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/account/general/ledger/scene/elements/all`,
      params
    );
  },
  ...
  addOrUpdateSobElements(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/generalLedgerSceneMappingGrpsHd/insert/head/and/line`,
      params
    );
  },
  ...
  getSobElement(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/generalLedgerSceneMappingGrpsHd/selectByInput`,
      params
    );
  },
  ...
  getMatchGroupById(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/generalLedgerSceneMappingGrpsHd/get/account/view/by/head/id`,
      params
    );
  },
  ...
  batchInsertOrUpdateSection(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/generalLedgerSceneMappingDetails/insertOrUpdateBatch`,
      params
    );
  },
  ...
  batchDeleteSection(params) {
    return httpFetch.delete(
      `${config.accountingUrl}/api/generalLedgerSceneMappingDetails/deleteByIds`,
      params
    );
  },

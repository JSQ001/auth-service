...
export default {
  ...
  addSysAccountingElements(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/account/general/ledger/scene/elements`,
      params
    );
  },
  ...
  getMatchGroupField(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/match/group/filed/selectByInput`,
      params
    );
  },
  ...
  getElement(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/account/general/ledger/scene/elements/query`,
      params
    );
  },
};

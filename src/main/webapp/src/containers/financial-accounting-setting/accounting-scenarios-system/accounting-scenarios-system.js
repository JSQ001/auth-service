...
class AccountingScenariosSystem extends React.Component {
      ...
      columns: [
        ...
        // },
        {
          ...
          render: (text, record, index) => (
            <span>
              <a onClick={e => this.handleLinkElement(e, record, index)}>
  ...
  handleLinkElement = (e, record, index) => {
    this.props.dispatch(
      routerRedux.replace({
        pathname: '/financial-accounting-setting/accounting-scenarios-system/accounting-elements/:id'.replace(
          ':id',
          record.id
        ),
      })

...
export default {
  ...
  getSectionStructuresByOptions(params) {
    return httpFetch.get(
      `${config.accountingUrl}/accounting_service/api/general/ledger/segment/sets/query`,
      params
    );
  },
  ...
  addSectionStructure(params) {
    return httpFetch.post(
      `${config.accountingUrl}/accounting_service/api/general/ledger/segment/sets`,
      params
    );
  },
  ...
  getSectionSettingsByOptions(params) {
    return httpFetch.get(
      `${config.accountingUrl}/accounting_service/api/general/ledger/segments/query`,
      params
    );
  },
  ...
  getSectionMapSet(params) {
    return httpFetch.get(
      `${config.accountingUrl}/accounting_service/api/general/ledger/segment/map/query`,
      params
    );
  },
  ...
  downLoadMapping(params) {
    return httpFetch.get(
      `${config.accountingUrl}/accounting_service/api/general/ledger/segment/map/export/data`,
      params
    );
  },
  ...
  deleteSectionMap(params) {
    return httpFetch.delete(
      `${config.accountingUrl}/accounting_service/api/general/ledger/segment/map/batch`,
      params
    );
  },
  ...
  getSourceTransactionData(params) {
    return httpFetch.get(
      `${config.localUrl}/api/accounting/util/general/ledger/fields/data/source`,
      params
    );
  },
  ...
  addSourceTransactionSob(setOfBooksId, params) {
    return httpFetch.post(
      `${config.localUrl}/api/general/ledger/sob/source/transactions?setOfBooksId=${setOfBooksId}`,
      params
    );
  },
  ...
  getSourceTransactionSob(params) {
    return httpFetch.get(
      `${config.localUrl}/api/general/ledger/sob/source/transactions/query`,
      params
    );
  },
  ...
  getSourceTransactionDataSob(params) {
    return httpFetch.post(
      `${config.localUrl}/api/general/source/transaction/data/tables/query`,
      params
    );
  },
  ...
  addSourceTransactionModelSob(sobSourceTransactionId, params) {
    return httpFetch.post(
      `${
        config.localUrl
      }/api/general/ledger/sob/journal/line/model?sobSourceTransactionId=${sobSourceTransactionId}`,
      params
    );
  },
  ...
  getSourceTransactionModelSob(params) {
    return httpFetch.get(
      `${config.localUrl}/api/general/ledger/sob/journal/line/model/query`,
      params
    );
  },
  ...
  addSourceLineModelDataRules(params) {
    return httpFetch.post(
      `${config.localUrl}/api/general/ledger/journal/line/model/data/rules`,
      params
    );
  },
  ...
  getSourceLineModelDataRules(params) {
    return httpFetch.get(
      `${config.localUrl}/api/general/ledger/journal/line/model/data/rules/query`,
      params
    );
  },
  ...
  addSourceLineModelChangeRules(params) {
    return httpFetch.post(
      `${config.localUrl}/api/general/ledger/journal/line/model/change/rules`,
      params
    );
  },
  ...
  addSourceLineModelJudgeRules(params) {
    return httpFetch.post(
      `${config.localUrl}/api/general/ledger/journal/line/model/judge/rules`,
      params
    );
  },
  ...
  getSourceLineModelJudgeRules(params) {
    return httpFetch.get(
      `${config.localUrl}/api/general/ledger/journal/line/model/judge/rules/query`,
      params
    );
  },
  ...
  addSourceLineModelRules(params) {
    return httpFetch.post(
      `${config.localUrl}/api/general/ledger/sob/transaction/account/rules`,
      params
    );
  },
  ...
  getSourceLineModelRules(params) {
    return httpFetch.get(
      `${config.localUrl}/api/general/ledger/sob/transaction/account/rules/query`,
      params
    );
  },
  ...
  getSegmentBySetOfBooksId(setOfBooksId) {
    return httpFetch.get(
      `${
        config.localUrl
      }/api/general/ledger/segment/sets/querySegmentBySetOfBooksId?setOfBooksId=${setOfBooksId}`
    );
  },
  ...
  getAccountingScenarios(params) {
    return httpFetch.get(
      `${config.accountingUrl}/accounting_service/api/account/general/ledger/scene/query`,
      params
    );
  },
  ...
  updateAccountingScenarios(params) {
    return httpFetch.put(
      `${config.accountingUrl}/accounting_service/api/account/general/ledger/scene`,
      params
    );
  },
  ...
  addSysAccountingElements(params) {
    return httpFetch.post(
      `${config.accountingUrl}/accounting_service/api/account/general/ledger/scene/elements`,
      params
    );
  },
  ...
  getSysScenariosById(params) {
    return httpFetch.get(
      `${config.accountingUrl}/accounting_service/api/account/general/ledger/scene/${params}`
    );
  },
  ...
  getMatchGroupField(params) {
    return httpFetch.get(
      `http://192.168.1.195:9998/api/general/match/group/filed/selectByInput`,
      params
    );
  },
  ...
  getElement(params) {
    return httpFetch.get(
      `http://192.168.1.72:9988/api/account/general/ledger/scene/elements/query`,
      params
    );
  },
  ...
  getScenariosSob(params) {
    return httpFetch.get(
      `http:////192.168.1.195:9091/api/generalLedgerSceneMapping/selectByInput`,
      params
    );
  },
  ...
  addOrUpdateScenarios(params) {
    return httpFetch.post(
      `http://192.168.1.195:9998/api/generalLedgerSceneMapping/insertOrUpdate`,
      params
    );
  },
  ...
  getScenarioNotInSob(params) {
    return httpFetch.get(
      `http://192.168.1.195:9091/api/generalLedgerSceneMapping/select/unassigned/scene`,
      params
    );
  },
  ...
  getElementsGroupNotNull(params) {
    return httpFetch.get(
      `http://192.168.1.195:9091/api/account/general/ledger/scene/elements/all`,
      params
    );
  },
  ...
  addOrUpdateSobElements(params) {
    return httpFetch.post(
      `http://192.168.1.195:9091/api/generalLedgerSceneMappingGrpsHd/insert/head/and/line`,
      params
    );
  },
  ...
  getSobElement(params) {
    return httpFetch.get(
      `http://192.168.1.195:9091/api/generalLedgerSceneMappingGrpsHd/selectByInput`,
      params
    );
  },
  ...
  getMatchGroupById(params) {
    return httpFetch.get(
      `http://192.168.1.195:9091/api/generalLedgerSceneMappingGrpsHd/get/account/view/by/head/id`,
      params
    );
  },
  ...
  getSectionMatchByOptions(params, body) {
    return httpFetch.post(
      `http://192.168.1.195:9091/api/generalLedgerSceneMappingDetails/get/details/by/codes?headId=${
        params.headId
  ...
  batchInsertOrUpdateSection(params) {
    return httpFetch.post(
      `http://192.168.1.195:9091/api/generalLedgerSceneMappingDetails/insertOrUpdateBatch`,
      params
    );
  },
  ...
  batchDeleteSection(params) {
    return httpFetch.delete(
      `http://192.168.1.195:9091/api/generalLedgerSceneMappingDetails/deleteByIds`,
      params
    );
  },
};

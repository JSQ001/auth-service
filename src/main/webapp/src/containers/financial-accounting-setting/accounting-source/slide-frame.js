...
class SlideFrame extends React.Component {
  ...
  render() {
    return (
      <div>
        <div
          className={this.props.hasMask && this.state.showFlag ? 'slide-mask' : 'hide'}
          onClick={this.props.onClose}
        />
        <div className={this.state.className} style={{ width: this.props.width }}>
          <div className="slide-title">
            {this.props.title}
            <Icon type="close" className="close-icon" onClick={this.props.onClose} />
          </div>
          <div className="slide-content">{this.wrapClose(this.props.content)}</div>
        </div>
      </div>
    );
  }

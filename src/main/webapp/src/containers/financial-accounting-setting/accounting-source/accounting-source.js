...
class AccountingSource extends React.Component {
      ...
      searchForm: [
        {
          type: 'select',
          id: 'setOfBooksId',
          label: this.$t({ id: 'paymentCompanySetting.setOfBooks' }),
          options: [],
          defaultValue: '',
          isRequired: true,
        ...
        },
        {
          ...
          type: 'input',
          id: 'description',
          label: this.$t({ id: 'accounting.source.name' }),
        },
      ],
      columns: [
        {
        ...
        },
        {
          ...
          render: (text, record, index) => (
            <span>
              <a onClick={e => this.handleLinkTemplate(e, record, index)}>
                {this.$t({ id: 'accounting.source.setOfBook.template' })}
              </a>{' '}
              {/*凭证模板*/}
            </span>
          ),
  ...
  componentWillMount() {
    ...
    accountingService.getSetOfBooksByTenant().then(res => {
      ...
      let setOfBooksId =
        this.props.match.params.sourceSetOfBooksId &&
        this.props.match.params.sourceSetOfBooksId != ':sourceSetOfBooksId'
  ...
  getList() {
    ...
    params.sourceTransactionCode = this.state.searchParams.sourceTransactionCode
      ? this.state.searchParams.sourceTransactionCode
      : '';
  ...
  handleListOk = value => {
    ...
    this.setState({ loading: true });
    accountingService
      .addSourceTransactionSob(this.state.setOfBooksId, valueData)
      .then(() => {
        message.success(`${this.$t({ id: 'common.operate.success' })}`);
    ...
    return (
      <div className="accounting-source">
        <SearchArea
          ...
          eventHandle={this.handleSetOfBookChang}
        />

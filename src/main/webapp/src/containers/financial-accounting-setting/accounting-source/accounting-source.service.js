...
export default {
  ...
  getTableField(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/accounting/util/general/ledger/fields/data/source/fields`,
      params
    );
  },
  ...
  getSourceLineModelDataRulesById(id) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/data/rules/${id}`
    );
  },
  ...
  getSourceLineModelRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/sob/transaction/account/rules/query`,
      params
    );
  },
  ...
  getElementsByTransActionSceneId(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/account/general/ledger/scene/elements/queryAll`,
      params
    );
  },
  ...
  getSegmentBySetOfBooksId(setOfBooksId, sobJournalLineModelId) {
    return httpFetch.get(
      `${
        config.accountingUrl
      }/api/general/ledger/segment/sets/querySegmentBySetOfBooksId?setOfBooksId=${setOfBooksId}&sobJournalLineModelId=${sobJournalLineModelId}`
    );
  },

  //根据租户查询帐套信息
  getSetOfBooksByTenant() {
    return httpFetch.get(`${config.mdataUrl}/api/setOfBooks/by/tenant?roleType=TENANT`);
  },
};

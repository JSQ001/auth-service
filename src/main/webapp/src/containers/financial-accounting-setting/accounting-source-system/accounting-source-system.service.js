...
export default {
  ...
  addSourceTransactionData(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/source/transaction/data/tables`,
      params
    );
  },
  ...
  delectSourceTransactionData(id) {
    return httpFetch.delete(
      `${config.accountingUrl}/api/general/source/transaction/data/tables/${id}`
    );
  },
  /**
   * 查询来源数据结构byID（系统级）
  ...
  getSourceTransactionData(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/accounting/util/general/ledger/fields/data/source`,
      params
    );
  },
  ...
  addSourceTransactionSob(setOfBooksId, params) {
    return httpFetch.post(
      ...
      }/api/general/ledger/sob/source/transactions?setOfBooksId=${setOfBooksId}`,
      params
    );
  },
  ...
  upSourceTransactionSob(params) {
    return httpFetch.put(
      `${config.accountingUrl}/api/general/ledger/sob/source/transactions`,
      params
    );
  },
  ...
  delectSourceTransactionSob(id) {
    return httpFetch.delete(
      `${config.accountingUrl}/api/general/ledger/sob/source/transactions/${id}`
    );
  },
  ...
  getSourceTransactionSob(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/sob/source/transactions/query`,
      params
    );
  },
  ...
  getSourceTransactionDataSob(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/source/transaction/data/tables/query`,
      params
    );
  },
  ...
  upSourceTransactionModelSob(params) {
    return httpFetch.put(
      `${config.accountingUrl}/api/general/ledger/sob/journal/line/model`,
      params
    );
  },
  ...
  delectSourceTransactionModelSob(id) {
    return httpFetch.delete(
      `${config.accountingUrl}/api/general/ledger/sob/journal/line/model/${id}`
    );
  },
  ...
  getSourceTransactionModelSob(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/sob/journal/line/model/query`,
      params
    );
  },
  ...
  getGlScene(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/account/general/ledger/scene/queryAll`,
      params
    );
  },
  ...
  addSourceLineModelDataRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/data/rules`,
      params
    );
  },
  ...
  getSourceLineModelDataRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/data/rules/query`,
      params
    );
  },
  ...
  addSourceLineModelChangeRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/change/rules`,
      params
    );
  },
  ...
  getSourceLineModelChangeRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/change/rules/query?`,
      params
    );
  },
  ...
  addSourceLineModelJudgeRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/judge/rules`,
      params
    );
  },
  ...
  getSourceLineModelJudgeRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/judge/rules/query`,
      params
    );
  },
  ...
  addSourceLineModelRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/sob/transaction/account/rules`,
      params
    );
  },
  ...
  getSystemSourceLineModelJudgeRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/judge/rules/query`,
      params
    );
  },
  ...
  addSystemSourceLineModelJudgeRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/judge/rules`,
      params
    );
  },
  ...
  getSystemSourceLineModelDataRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules/query`,
      params
    );
  },
  ...
  getSystemSourceLineModelDataRulesById(id) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules/${id}`
    );
  },
  ...
  getSystemSourceLineModelChangeRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/change/rules/query?`,
      params
    );
  },
  ...
  getSystemSourceLineModelRules(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/general/ledger/system/transaction/account/rules/query`,
      params
    );
  },
  ...
  addSystemSourceLineModelRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/system/transaction/account/rules`,
      params
    );
  },
  ...
  addSystemSourceLineModelChangeRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/change/rules`,
      params
    );
  },
  ...
  addSystemSourceLineModelDataRules(params) {
    return httpFetch.post(
      `${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules`,
      params
    );
  },
  ...
  getSourceTransactionDataValue(params) {
    return httpFetch.get(
      `${config.accountingUrl}/api/accounting/util/general/ledger/fields/data/source/relate`,
      params
    );
  },
};

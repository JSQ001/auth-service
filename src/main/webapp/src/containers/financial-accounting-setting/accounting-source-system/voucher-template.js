...
class AccountingSource extends React.Component {
    ...
    this.state = {
      ...
      columns: [
        ...
        },
        {
          ...
          key: 'basicSourceDateDes',
          dataIndex: 'basicSourceDateDes',
        },
        {
          /*状态*/
  ...
  handleBack = () => {
    this.props.dispatch(
      routerRedux.replace({
        pathname: '/financial-accounting-setting/accounting-source-system/accounting-source-system',
      })
    );
  };
  ...
  render() {
    ...
    return (
      <div className="voucher-template" style={{ paddingBottom: 20 }}>
        ...
        >
          <NewUpdateVoucherTemplate onClose={this.handleAfterClose} params={lov.params} />
        </SlideFrame>
      </div>
    );
  }

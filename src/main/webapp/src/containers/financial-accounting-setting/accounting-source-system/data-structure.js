  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        {
          /*数据结构代码*/
          title: this.$t({ id: 'data.structure.code' }),
          key: 'code',
          dataIndex: 'code',
        },
        {
          /*数据结构名称*/
          title: this.$t({ id: 'data.structure.name' }),
          key: 'description',
      ...
      <div className="section-mapping-set">
        <div className="table-header">
          <div className="table-header-title">
            {this.$t({ id: 'common.total' }, { total: `${total}` })}
          </div>
          {/*共搜索到*条数据*/}
        </div>
        <Table loading={loading} dataSource={data} columns={columns} bordered size="middle" />

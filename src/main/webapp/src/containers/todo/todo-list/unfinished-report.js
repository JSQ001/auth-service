...
class UnFinishedReport extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      searchForm: [
  ...
  render() {
    ...
    return (
      <div className="approval">
        ...
        <CustomTable
          columns={columns}
          url={`${config.workflowUrl}/api/workflow/my/document/detail/2`}
...
export default connect(mapStateToProps)(UnFinishedReport);

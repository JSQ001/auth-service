...
class PersonGroup extends React.Component {
    ...
    this.state = {
      ...
      searchForm: [
        /*人员组名称*/
        {
          ...
          id: 'personGroupName',
          defaultValue: '',
          label: this.$t({ id: 'setting.personGroupName' }),
        },
      ],
      columns: [
        {
          /*人员组代码*/
          title: this.$t({ id: 'person.group.code' }),
          key: 'code',
          dataIndex: 'code',
          align: 'center',
        },
        {
          /*人员组名称*/
          title: this.$t({ id: 'person.group.name' }),
          key: 'name',
          dataIndex: 'name',
          align: 'center',
        },
        {
          /*描述*/
          title: this.$t({ id: 'person.group.desc' }),
          key: 'comment',
          dataIndex: 'comment',
          align: 'center',
        },
  ...
  handleCreate = () => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/person-group/person-group/new-person-group`,
      })
    );
  };
  //编辑人员组
  editItemUserGroup = record => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/person-group/person-group/edit-person-group/${
          record.userGroupOid
        }`,
      })
    );

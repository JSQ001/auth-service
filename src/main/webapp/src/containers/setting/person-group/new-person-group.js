...
class NewPersonGroup extends React.Component {
          ...
          PGService.UpdatePersonGroup(_userGroup)
            .then(response => {
              if (response) {
                ...
                this.props.dispatch(
                  routerRedux.push({
                    pathname: `/admin-setting/person-group/person-group/person-group-detail/${
                      response.data.userGroupOid
                    }`,
                  })
                );
              }
  ...
  handleCancel = e => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/person-group/person-group`,
      })
    );
  };
    ...
    return (
      <div className="new-person-group">
        <Form onSubmit={this.handleSave} onChange={this.handleChange}>
          <Row gutter={24}>
            <Col span={6}>
              <FormItem label={this.$t('person.group.code')} /*人员组代码*/ colon={true}>
            ...
            <Col span={6}>
              <FormItem label={this.$t('person.group.name')} /* 人员组名称*/ colon={true}>
            ...
            <Col span={6}>
              <FormItem label={this.$t('person.group.desc')} /* 人员组描述*/ colon={true}>
                {getFieldDecorator('comment', {
                  ...
                  <LanguageInput
                    ...
                    i18nName={
                      userGroup.i18n && userGroup.i18n.comment ? userGroup.i18n.comment : null
                    }
                    placeholder={this.$t('common.please.enter') /* 请输入 */}
                    isEdit={userGroup.id}
            ...
            {/* </Row>
                    <Row gutter={24}> */}
            <Col span={6}>
              <FormItem label={this.$t('common.column.status')} /* {/!*状态*!/}*/ colon={false}>

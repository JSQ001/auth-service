...
class NewCostCenter extends React.Component {
  ...
  componentWillMount() {
    CCService.getTenantAllSob().then(res => {
      ...
      <div className="new-cost-center">
        <Form onSubmit={this.handleSave} onChange={this.handleChange}>
          <Row gutter={24}>
            <Col span={8}>
              {/*成本中心代码*/}
              <FormItem label={this.$t('new.cost.center.code')} colon={true}>
                {getFieldDecorator('code', {
                  ...
                  <Input
                    disabled={
                      (costCenterDetail.id && costCenterDetail.code) || !this.props.tenantMode
                    }
            ...
            <Col span={8}>
              {/*账套*/}
              <FormItem label={this.$t('new.cost.center.sob')} colon={true}>
                {getFieldDecorator('setOfBooksId', {
                  ...
                  <Select
                    disabled={!this.props.tenantMode || costCenterDetail.setOfBooksName}

...
class CostCenter extends React.Component {
  ...
  disabledDepCostCenter = () => {
    CCService.toggleDepartment(false).then(res => {
      this.setState({
  ...
  enabledDepCostCenter = () => {
    CCService.toggleDepartment(true).then(res => {
      this.setState({
        depIsCostCenter: res.data.configuration.ui.showDepartmentSelector.applications,
      });
      //重置redux
        ...
        <div className="table-header">
          <div className="cost-center-dep-wrap">
            <div className="cost-center-dep">
              ...
              this.state.depIsCostCenter ? (
                <span>{this.$t('cost.center.enabled')}&nbsp;&nbsp;</span>
              ) : (
              ...
              <span className="cost-center-btn" onClick={this.goStructure}>
                &nbsp;{// 企业管理-组织架构
          ...
          <div className="table-header-buttons">
            ...
            <Button
              ...
              onClick={this.handleCostCenterExtendFiled}
            >
              {/*成本中心项扩展字段*/}

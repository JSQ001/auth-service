...
export default {
  ...
  toggleDepartment: function(enabled) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .put(config.baseUrl + '/api/company/configurations/set/cost/center/department/' + enabled)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  createCostCenter(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .post(config.baseUrl + '/api/cost/centers', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  updateCostCenter: function(costCenter) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .put(config.baseUrl + '/api/cost/centers/', costCenter)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCostCenterBySobId(params) {
    ...
    return new Promise(function(resolve, reject) {
      //这个接口需要做成，没有传账套就查询全部
      httpFetch
        .get(config.baseUrl + '/api/cost/center/company', params)
        .then(function(res) {
          resolve({
            data: res.data,
  ...
  getCostCenterDetail: function(costCenterOid) {
    return new Promise(function(resolve, reject) {
      //这个接口需要做成，没有传账套就查询全部
      httpFetch
        .get(config.baseUrl + '/api/cost/centers/simple/' + costCenterOid)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCostCenterItemsAll(costCenterOid, params) {
    ...
    return new Promise(function(resolve, reject) {
      //这个接口需要做成，没有传账套就查询全部
      httpFetch
        .get(config.baseUrl + '/api/cost/center/items/' + costCenterOid + '/all', params)
        .then(function(res) {
          resolve({
            data: res.data,
            total: Number.parseInt(res.headers['x-total-count']),
  ...
  downloadCostCenterItemTemplate: function() {
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(
          config.baseUrl + '/api/cost/center/items/template/download',
          {},
          {},
  ...
  downloadCostCenterItemPersonTemplate: function() {
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(
          config.baseUrl + '/api/cost/center/items/with/users/template/download',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
  ...
  importTemplateCostCenterOid: function(costCenterOid, file) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.baseUrl + '/api/cost/center/items/import/' + costCenterOid, file)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  importTemplateCostCenterPersonOid: function(file) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.baseUrl + '/api/cost/center/items/import/with/users', file)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  getCostCenterBatchTransactionLog: function(transactionOid) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.baseUrl + '/api/batch/transaction/logs/costcenteritem/' + transactionOid)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  exportCostCenterBatchTransactionLog: function(transactionOid) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(
          config.baseUrl +
            '/api/batch/transaction/logs/failed/export/costcenteritem/' +
            transactionOid,
          {},
          {},
          { responseType: 'arraybuffer' }
  ...
  exportCostCenterPersonBatchTransactionLog: function(transactionOid) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(
          config.baseUrl +
            '/api/batch/transaction/logs/failed/export/costcenteritem/with/user/' +
            transactionOid,
          {},
          {},
          { responseType: 'arraybuffer' }
  ...
  createCostCenterItem: function(costCenterOid, data) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .post(config.baseUrl + '/api/cost/center/items/' + costCenterOid, data)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  updateCostCenterItem: function(data) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .put(config.baseUrl + '/api/cost/center/items', data)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  costCenterItemAssociateUsersDTO: function(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .put(config.baseUrl + '/api/cost/center/items/with/users/', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCostCenterItemDetail: function(CostCenterItemOid) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.baseUrl + '/api/cost/center/item/' + CostCenterItemOid)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCostCenterItemUsers: function(params, CostCenterItemOid) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.baseUrl + '/api/cost/center/item/' + CostCenterItemOid + '/users', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  removeUserFromCostCenterItemAssociation: function(userOid, costCenterOid) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .delete(config.baseUrl + '/api/remove/user/' + userOid + '/cost/center/' + costCenterOid)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  batchUpdate(params) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .post(config.baseUrl + `/api/cost/center/items/batch/enable/or/disable`, params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  asDepartmentToCostcenteritem(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .post(config.mdataUrl + '/api/department/costcenteritem', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCostcenteritemDepartmentList(costCenterItemId, params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.mdataUrl + '/api/department/costcenteritem/by/' + costCenterItemId, params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  delDepartmentToCostcenteritem(costCenterItemDepartmentId) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .delete(config.mdataUrl + '/api/department/costcenteritem/' + costCenterItemDepartmentId)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {

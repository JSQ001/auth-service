  ...
  constructor(props) {
    ...
    this.state = {
      ...
      tabs: [
        {
          key: '0',
          value: this.$t('parameter.definition.teat'),
        },
        {
          key: '1',
          value: this.$t('parameter.definition.sob'),
        },
        {
          key: '2',
          value: this.$t('parameter.definition.comp'),
        },
      ],
    };
  }
  ...
  render() {
    ...
    return (
      <div className="parameter-definition">
        <Tabs onChange={this.handleTab} defaultActiveKey={'0'}>

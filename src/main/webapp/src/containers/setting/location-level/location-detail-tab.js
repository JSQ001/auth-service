...
import { Button, Icon, Divider, Badge, message } from 'antd';
import locationLevelService from './service';
import { messages } from 'utils/utils';
import { routerRedux } from 'dva/router';

class LocationDetailTab extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pagination: {
    ...
    return (
      <div style={{ marginTop: '15px' }}>
        ...
        <Button
          ...
          disabled={disabled}
          onClick={this.batchDeleteLocation}
        >
          移除地点
        </Button>
        <CustomTable
          ...
          url={`${config.mdataUrl}/api/location/level/queryLocationLevelAssign`}
...
export default connect(mapStateToProps)(LocationDetailTab);

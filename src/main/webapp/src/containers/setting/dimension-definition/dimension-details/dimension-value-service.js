...
export default {
  ...
  addNewDimensionValue(params) {
    const url = `${config.mdataUrl}/api/dimension/item`;
  ...
  delDimensionValue(dimensionItemId) {
    return httpFetch.delete(`${config.mdataUrl}/api/dimension/item/${dimensionItemId}`);
  },
  /**
   * 查询维值详情
   */
  getCurrentDimensionValue(dimensionItemId) {
    const url = `${config.mdataUrl}/api/dimension/item/${dimensionItemId}`;
  ...
  getCompanyList(params) {
    const url = `${config.mdataUrl}/api/dimension/item/assign/company/query`;
  ...
  addNewCompanyData(params) {
    const url = `${config.mdataUrl}/api/dimension/item/assign/company/batch`;
    return httpFetch.post(url, params);
  },
  /**
   * 公司状态：启用/关闭
  ...
  exportDimensionValue(params, dimensionId) {
    const url = `${config.mdataUrl}/api/dimension/item/export?dimensionId=${dimensionId}`;
  ...
  confirmImporter(transactionId) {
    const url = `${config.mdataUrl}/api/dimension/item/import/confirm/${transactionId}`;

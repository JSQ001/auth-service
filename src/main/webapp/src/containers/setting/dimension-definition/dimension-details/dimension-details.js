...
class DimensionDetails extends Component {
  ...
  onBackClick = e => {
    ...
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/admin-setting/dimension-definition/dimension-definition/${
    ...
    return (
      <div>
        <BasicInfo
          ...
          // colSpan="6"
        />
        <Tabs defaultActiveKey={tabKey} onChange={this.tabChange} style={{ margin: '20px 0' }}>
          <TabPane tab="维值定义" key="1">
            <DimensionDeValue dimensionId={dimensionId} setOfBooksId={setOfBooksId} />
          </TabPane>

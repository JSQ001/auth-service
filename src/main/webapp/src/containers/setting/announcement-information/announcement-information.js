...
class AnnouncementInformation extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        ...
        {
          title: this.$t('announcement.info.new.date' /*新建日期*/),
        ...
        },
        {
          ...
          render: (text, record) => (
            <span>
              <a onClick={e => this.handleRowClick(record)}>{this.$t('common.edit')}</a>
  ...
  handleListOk = result => {
    ...
    if (!companyList.length) {
      ...
      announcementService
        .handleCompanyDistribute(this.state.selectedCarouselOids, companyList)
        .then(() => {
          this.setState({
            selectedRowKeys: [],
            selectedRowIDs: [],
  ...
  handleNewAnnouncement = () => {
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/announcement-information/announcement-information/new-announcement-information`,
      })
    );
  };
  ...
  handleRowClick = record => {
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/announcement-information/announcement-information/announcement-information-detail/${
          record.carouselOid
        }/${record.id}`,
      })
    );
      ...
      <div className="announcement-information">
        <div className="table-header">
          <div className="table-header-buttons">
            <Button type="primary" onClick={this.handleNewAnnouncement}>

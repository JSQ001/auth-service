...
class NewDepartmentGroup extends React.Component {
  ...
  componentWillMount() {
    httpFetch.get(`${config.mdataUrl}/api/setOfBooks/by/tenant?roleType=TENANT`).then(response => {
      let setOfBooks = [];
  ...
  handleSave = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        httpFetch
          .post(`${config.mdataUrl}/api/DepartmentGroup/insertOrUpdate`, values)
          .then(response => {
            if (response) {
              ...
              this.props.dispatch(
                routerRedux.push({
                  pathname: `/admin-setting/department-group/department-group/department-group-detail/${
                    response.data.id
                  }`,
                })
              );
  ...
  handleCancel = e => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/department-group/department-group`,
      })
    );
  };

...
class WorkflowDetail extends React.Component {
  ...
  componentDidMount() {
    ...
    workflowService
      .getFormFields(this.props.params.formOid)
      .then(res => {
  ...
  getForm = () => {
    return new Promise((resolve, reject) => {
      workflowService
        .getCustomForm(this.props.params.formOid)
        .then(res => {
  ...
  getApprovalChain = () => {
    return new Promise((resolve, reject) => {
      workflowService
        .getApprovalChainDetail(this.props.params.formOid)
        .then(res => {
  ...
  goBack = () => {
    this.props.dispatch(
      routerRedux.replace({
        pathname: `/admin-setting/form-list/form-list/${this.props.params.booksID}`,
      })
    );
  };

        ...
        show: (
          <FormItem>
            {getFieldDecorator('ticket', {
              ...
              <Checkbox
                disabled={disabled}
                onChange={e => this.otherCheckboxChange(e, 'ticket', 'isTicketShow')}
              />
            )}
          </FormItem>
        ),
              ...
              <FormItem>
                {getFieldDecorator('fromCitiesR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'fromCitiesR', 'fromCities', 'required')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('toCitiesR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'toCitiesR', 'toCities', 'required')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('takeOffEndTimeS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'takeOffEndTimeS', 'takeOffEndTime', 'show')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('arrivalEndTimeS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'arrivalEndTimeS', 'arrivalEndTime', 'show')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('ticketPriceS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'ticketPriceS', 'ticketPrice', 'show')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('ticketPriceR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'ticketPriceR', 'ticketPrice', 'required')
                    }
                  />
                )}
              </FormItem>
            ...
            show: (
              <FormItem>
                {getFieldDecorator('discountS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => this.onFlightCheckboxChange(e, 'discountS', 'discount', 'show')}
                  />
                )}
              </FormItem>
            ),
              ...
              <FormItem>
                {getFieldDecorator('seatClassS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onFlightCheckboxChange(e, 'seatClassS', 'seatClass', 'show')
                    }
                  />
                )}
              </FormItem>
        ...
        show: (
          <FormItem>
            {getFieldDecorator('hotel', {
              ...
              <Checkbox
                disabled={disabled}
                onChange={e => this.otherCheckboxChange(e, 'hotel', 'isHotelShow')}
              />
            )}
          </FormItem>
        ),
            ...
            required: (
              <FormItem>
                {getFieldDecorator('cityHotelR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => this.onHotelCheckboxChange(e, 'cityHotelR', 'city', 'required')}
                  />
                )}
              </FormItem>
            ),
              ...
              <FormItem>
                {getFieldDecorator('maxPriceHotelS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onHotelCheckboxChange(e, 'maxPriceHotelS', 'maxPrice', 'show')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('maxPriceHotelR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onHotelCheckboxChange(e, 'maxPriceHotelR', 'maxPrice', 'required')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('minPriceHotelS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onHotelCheckboxChange(e, 'minPriceHotelS', 'minPrice', 'show')
                    }
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('minPriceHotelR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e =>
                      this.onHotelCheckboxChange(e, 'minPriceHotelR', 'minPrice', 'required')
                    }
                  />
                )}
              </FormItem>
        ...
        show: (
          <FormItem>
            {getFieldDecorator('train', {
              ...
              <Checkbox
                disabled={disabled}
                onChange={e => this.otherCheckboxChange(e, 'train', 'isTrainShow')}
              />
            )}
          </FormItem>
        ),
              ...
              <FormItem>
                {getFieldDecorator('fromCityTrainR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => {
                      this.onTrainCheckboxChange(e, 'fromCityTrainR', 'fromCity', 'required');
                    }}
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('toCityTrainR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => {
                      this.onTrainCheckboxChange(e, 'toCityTrainR', 'toCity', 'required');
                    }}
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('ticketPriceTrainS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => {
                      this.onTrainCheckboxChange(e, 'ticketPriceTrainS', 'ticketPrice', 'show');
                    }}
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('ticketPriceTrainR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => {
                      this.onTrainCheckboxChange(e, 'ticketPriceTrainR', 'ticketPrice', 'required');
                    }}
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('seatClassTrainS', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => {
                      this.onTrainCheckboxChange(e, 'seatClassTrainS', 'seatClass', 'show');
                    }}
                  />
                )}
              </FormItem>
              ...
              <FormItem>
                {getFieldDecorator('seatClassTrainR', {
                  ...
                  <Checkbox
                    disabled={disabled}
                    onChange={e => {
                      this.onTrainCheckboxChange(e, 'seatClassTrainR', 'seatClass', 'required');
                    }}
                  />
                )}
              </FormItem>
        ...
        show: (
          <FormItem>
            {getFieldDecorator('otherTransport', {
              ...
              <Checkbox
                disabled={disabled}
                onChange={e => this.otherCheckboxChange(e, 'otherTransport', 'otherTransport')}
              />
            )}
          </FormItem>
        ),
        ...
        show: (
          <FormItem>
            {getFieldDecorator('travelAllowances', {
              ...
              <Checkbox
                disabled={disabled}
                onChange={e => this.otherCheckboxChange(e, 'travelAllowances', 'travelAllowances')}
              />
            )}
          </FormItem>
        ),
    ...
    return (
      <div className="form-setting-travel">
        ...
        <div className="form-setting-buttons">
          {isEditing ? (
            <div>
              <Button type="primary" className="buttons-save" onClick={this.saveTravelForm}>

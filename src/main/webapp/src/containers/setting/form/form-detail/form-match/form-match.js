  ...
  constructor(props) {
    ...
    this.state = {
      ...
      applyTypeSelectorItem: {
        ...
        columns: [{ title: '申请单类型名称', dataIndex: 'formName' }],
        key: 'id',
        listKey: 'records',
      },
      isApply: false,
    ...
    return (
      <div className="form-permission">
        <Form style={{ marginBottom: '20px' }} onSubmit={this.save}>
          <div className="info-title">关联申请设置</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
          ...
          {isApply && (
            <div>
              <div className="info-title">关联次数限制</div>
              <FormItem>
                <Row>
                  <Col span={8} offset={2}>
                    {getFieldDecorator('allowAultipleConnections', {
                      ...
                      <Checkbox defaultChecked={form.allowAultipleConnections}>
                        同一申请允许多次关联
                      </Checkbox>
                    )}
                  </Col>
              ...
              <div className="info-title">关联申请单依据</div>
              <FormItem>
                <Row>
                  <Col span={8} offset={2}>
              ...
              <div className="info-title">可关联申请类型</div>
              <FormItem>
                <Row>
                  <Col span={8} offset={2}>
                ...
                <Row>
                  <Col span={8} offset={2}>
                    {getFieldDecorator('applyIds', {
                      ...
                      <Select
                        ref={ref => (this.applyTypeSelect = ref)}
                        disabled={applyTypeDisabled}
                        onDropdownVisibleChange={this.getApplyIds}
                      >
          ...
          <div className="info-title">预算管控设置</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
          ...
          <div className="info-title">关联合同设置</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
                {getFieldDecorator('relatedContract', {
                  ...
                  <Checkbox defaultChecked={form.relatedContract} onChange={this.normContract}>
                    关联合同
                  </Checkbox>
                )}
              </Col>
          ...
          {isRelation && (
            <div>
              <div className="info-title">合同布局位置</div>
              <FormItem>
                <Row>
                  <Col span={8} offset={2}>
                    {getFieldDecorator('contractPosition', {
                      initialValue: form.contractPosition
          ...
          <div className="info-title">收款方设置</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
          ...
          <div className="info-title">收款方属性</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
          ...
          <div className="info-title">付款方式类型设置</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
                <span>付款方式类型</span>
          ...
          <div className="info-title">付款用途</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
              ...
              <Col span={8} offset={2}>
                {getFieldDecorator('cashTransactionIds', {
                  ...
                  <Select
                    ...
                    disabled={isCashTransactionClass}
                    onFocus={this.getCashIds}
                  >
          ...
          <div className="info-title">核销依据</div>
          <FormItem>
            <Row>
              <Col span={8} offset={2}>
            ...
            <Row>
              <Col span={8} offset={2}>
                {getFieldDecorator('sameContract', {
                  ...
                  <Checkbox defaultChecked={form.sameContract} onChange={this.commonContract}>
                    关联相同合同
                  </Checkbox>
                )}
              </Col>
          ...
          <Row>
            <Col span={8} offset={2}>
              ...
              <Button type="default" onClick={this.backFun}>
                返回
              </Button>
            </Col>
          </Row>

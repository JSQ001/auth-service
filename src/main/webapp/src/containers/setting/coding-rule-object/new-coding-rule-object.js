      ...
      if (!err) {
        ...
        codingRuleService
          ...
          .then(res => {
            ...
            this.props.dispatch(
              routerRedux.push({
                pathname: '/admin-setting/coding-rule-object/coding-rule/' + res.data.id,
              })
            );
        ...
        <Form onSubmit={this.handleSave}>
          ...
          <FormItem wrapperCol={{ offset: 7 }}>
            <Row gutter={1}>
              ...
              <Col span={3}>
                <Button onClick={this.cancel}>{messages('common.cancel') /* 取消 */}</Button>
              </Col>
            </Row>
          </FormItem>
        </Form>

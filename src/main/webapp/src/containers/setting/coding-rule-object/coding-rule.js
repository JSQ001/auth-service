...
class CodingRuleDetail extends React.Component {
  ...
  getList() {
    ...
    return codingRuleService
      .getCodingRuleList(pagination.page, pagination.pageSize, this.props.match.params.id)
      .then(response => {
  ...
  updateInfo = params => {
    ...
    codingRuleService
      .updateCodingRuleObject(Object.assign({}, this.state.infoData, params))
      .then(res => {
  ...
  handleRowClick = record => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname:
          '/admin-setting/coding-rule-object/coding-rule-value/' +
  ...
  handleNew = () => {
    this.props.dispatch(
      routerRedux.push({
        pathname: '/admin-setting/coding-rule-object/new-coding-rule/' + this.props.match.params.id,
      })
    );
  ...
  cancel = () => {
    this.props.dispatch(
      routerRedux.push({
        pathname: '/admin-setting/coding-rule-object/coding-rule-object',
      })
    );
  };

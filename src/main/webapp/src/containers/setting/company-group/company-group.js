...
class CompanyGroup extends React.Component {
  ...
  handleCreate = () => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/company-group/company-group/new-company-group/NEW`,
      })
    );
  };
  ...
  handleRowClick = (record, index, event) => {
    ...
    this.props.dispatch(
      routerRedux.push({
        pathname: `/admin-setting/company-group/company-group/company-group-detail/${record.id}`,
      })
    );
  };

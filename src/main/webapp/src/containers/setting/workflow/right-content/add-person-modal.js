    ...
    return (
      <div className="add-person-modal">
        ...
        <Modal
          title={
            personType === 1
              ? this.$t('setting.key1253' /*请选择审批人员*/)
              : this.$t('setting.key1254' /*请选择知会人员*/)
          }
          visible={visible}
          width={550}
          closable={true}
          ...
          <Spin spinning={loading}>
            <List itemLayout="horizontal">
              <ListItem className="dep-by-applicant">
                <h4>
                  {personType === 1
                    ? this.$t('setting.key1255' /*按申请人所在的组织架构审批*/)
              ...
              <ListItem className="dep-by-bill">
                <div>
                  <h4>
                    {personType === 1
                      ? this.$t('setting.key1257' /*按单据上的组织架构审批*/)
                  ...
                  >
                    {personType === 1
                      ? this.$t('setting.key1259' /*分摊组织领导会签*/)
              ...
              <ListItem className="direct-manager">
                ...
                >
                  {personType === 1
                    ? this.$t('setting.key1271' /*参与审批*/)
                    : this.$t('setting.key1272' /*知会*/)}
                </Checkbox>
              </ListItem>
              ...
              <ListItem className="user-group-approver">
                <div>
                  <h4>
                    {personType === 1
                      ? this.$t('setting.key1276' /*指定人员组审批*/)

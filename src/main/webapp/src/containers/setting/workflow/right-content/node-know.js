        ...
        { label: this.$t('setting.key1396' /*APP消息*/), value: 'isApp' },
        {
          label: (
            <div className="notify-weChat">
              ...
              <span>
                {' '}
                {this.$t('setting.key1398' /*请先开通微信企业号，并联系客服启用融智汇微信版本*/)}
              </span>
            </div>
          ),
          value: 'isWeChat',
      ...
      <div className="node-know">
        <Card className="basic-info-container">
          ...
          <Form onSubmit={this.handleSaveBasicInfo}>
            ...
            <FormItem
              {...formItemLayout}
              label={this.$t('setting.key1400' /*知会方式*/)}
              colon={false}
            >
            ...
            <FormItem
              {...formItemLayout}
              label={this.$t('setting.key1401' /*知会格式*/)}
              colon={false}
            >
              <div>
                {this.$t('setting.key1402' /*点击知会消息将进入单据详情页，只能查看，不可编辑*/)}
              </div>
              <FormItem
                {...formItemLayout}
                label={this.$t('setting.key1403' /*标题*/)}
                colon={false}
              >
                ...
                {getFieldDecorator('title', {
                  ...
                  <Input
                    placeholder={this.$t('setting.key1405' /*可输入自定义标题，最多20个字符*/)}
                    style={{ width: 400 }}
                    autoComplete="off"
                    onChange={e => {
                ...
                <h4 className="notify-title-show">
                  {this.$t('setting.key1406' /*知会标题预览*/)}：
                </h4>
                <div>
                  {user.fullName} - {formInfo.formName}
                  {notifyTitle ? ` - ${notifyTitle}` : ''}
                </div>
              </FormItem>
              <FormItem
                {...formItemLayout}
                label={this.$t('setting.key1407' /*正文*/)}
                colon={false}
              >
                ...
                {getFieldDecorator('content', {
                  ...
                  <TextArea
                    placeholder={this.$t('setting.key1409' /*可输入自定义事由，最多100个字符*/)}
                    rows={3}

...
const chooserData = {
  ...
  filter_user: {
    title: messages('chooser.data.selectPerson'), //选择人员
    url: config.mdataUrl + '/api/user/groups/user/filter',
    searchForm: [
      {
        type: 'input',
        id: 'keyword',
  ...
  user_group: {
    ...
    url: `${config.mdataUrl}/api/user/groups/search?enabled=true`,
  ...
  budget_item: {
    ...
    searchForm: [
      { type: 'input', id: 'itemCode', label: messages('chooser.data.code') },
      {
        ...
        getUrl: `${
          config.budgetUrl
        }/api/budget/items/find/all?enabled=true&organizationId=:organizationId`,
        labelKey: 'itemCode',
        valueKey: 'itemCode',
        method: 'get',
        renderOption: data => `${data.itemCode}(${data.itemName})`,
  ...
  available_company: {
    title: '选择公司',
    url: `${config.mdataUrl}/api/company/available`,
    ...
    columns: [
      ...
      },
      {
        ...
        render: (value, record) => {
          ...
          return React.Component.prototype.checkFunctionProfiles('department.full.path.disabled', [
            undefined,
            false,
          ]) ? (
  ...
  cost_center_item: {
    title: messages('chooser.data.dimension'), //成本中心
    url: `${config.mdataUrl}/api/dimension/items`,
    ...
    searchForm: [
      {
        type: 'input',
        id: 'companyId',
        label: messages('chooser.data.companyName'),
        defaultValue: '',
      },

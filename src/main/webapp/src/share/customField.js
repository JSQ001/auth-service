...
export default {
  ...
  renderForm({
    ...
    switch (field.messageKey) {
      ...
      case 'select_cost_center':
        ...
        chooserItem.url = `${config.mdataUrl}/api/dimension/item/page/by/cond/${field.dataSource &&
          JSON.parse(field.dataSource || '{}').dimensionId}`;
        return (
          <Chooser
            selectorItem={chooserItem}
            placeholder={field.promptInfo}
      ...
      case 'select_participant':
        ...
        chooserItem.url += `?proposerOid=${
          app.getState().user.currentUser.userOid
      ...
      case 'select_box':
        return (
          <Select
            ...
            labelInValue
            mode={
              JSON.parse(field.fieldConstraint.replace(/\\/g, '') || '{}').type === '1'
                ? 'multiple'
                : '-'
            }
          >
      ...
      case 'select_company':
        ...
        let selectorItemCompany = {
          url: `${config.mdataUrl}/api/refactor/companies/user/setOfBooks?userOid=${
            app.getState().user.currentUser.userOid
  ...
  getInitialValue(field) {
    ...
    switch (field.messageKey) {
      ...
      case 'select_cost_center':
        return field.value
          ? [{ name: field.showValue, costCenterItemOdi: field.value }]
          : undefined;
      case 'select_corporation_entity':
        return field.value

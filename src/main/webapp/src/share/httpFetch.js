...
axios.interceptors.request.use(function(config) {
  ...
  config.headers['X-Menu-Id'] = store.getState().menu.currentMenuId;
  config.headers['X-Menu-Params'] = store.getState().menu.currentMenuParams;
...
const httpFetch = {
  ...
  refreshToken: function() {
    ...
    return new Promise((resolve, reject) => {
      let refreshParams = `client_id=ArtemisWeb&client_secret=nLCnwdIhizWbykHyuZM6TpQDd7KwK9IXDK8LGsa7SOW&refresh_token=${window.sessionStorage.getItem(
        'refresh_token'

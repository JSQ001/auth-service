...
import { Form, Card, Row, Col, Badge, Icon, Tooltip, Popover, Modal } from 'antd';
...
class BasicInfo extends React.Component {
  ...
  getInfo() {
    ...
    infoList.map((item, index) => {
      ...
      if (item.items) {
        ...
        children.push(
          <Col
            span={this.props.colSpan ? this.props.colSpan : 8}
  ...
  render() {
    const { cardShow, searchForm, loading, previewVisible, previewImage } = this.state;
    let EditBtn = null;

  ...
  componentWillReceiveProps(nextProps) {
    this.setState(
      ...
      () => {
        ...
        customFrom.customFormFields &&
          !customFrom.customFormFields.length &&
          customFromOriginList.length &&
          this.state.customFromOriginList.map(item =>
            customFrom.customFormFields.push({ ...item, _active: true })
          );

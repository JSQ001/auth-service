...
const dynamicWrapper = (app, models, component) => {
  ...
  if (component.toString().indexOf('.then(') < 0) {
    models.forEach(directory => {
      let model = require(`containers/${directory}/model.js`).default;
...
export const getRouterData = app => {
  const routerConfig = {
    ...
    //待办事项
    '/todo-list/todo-list': {
      component: dynamicWrapper(app, [], () => import('containers/todo/todo-list/todo-list.js')),
      name: 'todo-list',
      parent: '/todo-list',
    },
  };
